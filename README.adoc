...
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/6.1.0/reference/html/index.html[Spring Framework on Google Cloud 6.1.0 (Latest)] - https://googleapis.dev/java/spring-cloud-gcp/6.1.0/index.html[Javadocs 6.1.0]
// {x-version-update-end}
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/5.11.2/reference/html/index.html[Spring Framework on Google Cloud 5.11.2] - https://googleapis.dev/java/spring-cloud-gcp/5.11.2/index.html[Javadocs 5.11.2]
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/4.10.18/reference/html/index.html[Spring Framework on Google Cloud 4.10.18] - https://googleapis.dev/java/spring-cloud-gcp/4.10.18/index.html[Javadocs 4.10.18]
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/3.8.17/reference/html/index.html[Spring Framework on Google Cloud 3.8.17] - https://googleapis.dev/java/spring-cloud-gcp/3.8.17/index.html[Javadocs 3.8.17]
...
|No
|===
&ast; The Spring Cloud GCP 5.x link:spring-cloud-gcp-starters/spring-cloud-gcp-starter-trace[Trace Starter] and link:spring-cloud-gcp-autoconfigure/src/main/java/com/google/cloud/spring/autoconfigure/trace[Trace AutoConfiguration] module only supports Spring Boot 3.3.x due to link:https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-3.3-Release-Notes#brave-and-zipkin[Boot's major version increment] of its Brave and Zipkin dependencies.
