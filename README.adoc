...
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/3.4.0/reference/html/index.html[Spring Cloud GCP 3.4.0]
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/2.0.11/reference/html/index.html[Spring Cloud GCP 2.0.11]
...
|===
| Spring Cloud GCP | Spring Cloud | Spring Boot | Spring Framework | Supported
...
|3.x | https://github.com/spring-cloud/spring-cloud-release/wiki/Spring-Cloud-2021.0-Release-Notes[2021.0.x] (3.1/Jubilee) |2.6.x | 5.3.x| Yes
|===
