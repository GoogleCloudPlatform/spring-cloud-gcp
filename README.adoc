...
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/7.1.0/reference/html/index.html[Spring Framework on Google Cloud 7.0.0 (Latest)] - https://googleapis.dev/java/spring-cloud-gcp/7.0.0/index.html[Javadocs 7.0.0]
