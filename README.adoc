...
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/5.0.1/reference/html/index.html[Spring Framework on Google Cloud 5.0.0 (Latest)] - https://googleapis.dev/java/spring-cloud-gcp/5.0.0/index.html[Javadocs 5.0.0]
