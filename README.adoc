...
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/2.0.5/reference/html/index.html[Spring Cloud GCP 2.0.5]
...
For example, the version `2.0.6-SNAPSHOT` is available from this repository.
