...
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/6.1.2/reference/html/index.html[Spring Framework on Google Cloud 6.1.1 (Latest)] - https://googleapis.dev/java/spring-cloud-gcp/6.1.1/index.html[Javadocs 6.1.1]
