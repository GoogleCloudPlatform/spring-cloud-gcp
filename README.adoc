...
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/6.2.1/reference/html/index.html[Spring Framework on Google Cloud 6.2.1] - https://googleapis.dev/java/spring-cloud-gcp/6.2.1/index.html[Javadocs 6.2.1]
