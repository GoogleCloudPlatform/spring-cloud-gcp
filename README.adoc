...
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/4.10.12/reference/html/index.html[Spring Framework on Google Cloud 4.10.15] - https://googleapis.dev/java/spring-cloud-gcp/4.10.15/index.html[Javadocs 4.10.12]
