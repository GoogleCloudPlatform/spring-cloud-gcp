...
This is a test section to debug the variable rendering.

Test 1: Simple variable substitution
:my-test-version: 1.2.3
This should be 1.2.3: {my-test-version}

Test 2: Variable in a link
link:https://example.com/{my-test-version}[Link with version {my-test-version}]

Test 3: URL with variable
https://example.com/{my-test-version}[URL with version {my-test-version}]

Test 4: Using the existing version variables
This should be 6.4.0: {version-6}