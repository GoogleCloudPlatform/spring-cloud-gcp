...
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/3.1.0/reference/html/index.html[Spring Cloud GCP 3.1.0]
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/2.0.8/reference/html/index.html[Spring Cloud GCP 2.0.8]
...
|2.0.x |https://github.com/spring-cloud/spring-cloud-release/wiki/Spring-Cloud-2020.0-Release-Notes[2020.0.x] (3.0/Illford) |2.4.x, 2.5.x|5.3.x
|3.x | https://github.com/spring-cloud/spring-cloud-release/wiki/Spring-Cloud-2021.0-Release-Notes[2021.0.x] (3.1/Jubilee) |2.6.x | 5.3.x
|===
...
For details on how Spring Boot finds these properties, refer to the https://spring.io/projects/spring-cloud-gcp[documentation].
