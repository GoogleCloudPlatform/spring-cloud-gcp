...
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/7.3.1/reference/html/index.html[Spring Framework on Google Cloud 7.3.0 (Latest)] - https://googleapis.dev/java/spring-cloud-gcp/7.3.0/index.html[Javadocs 7.3.0]
