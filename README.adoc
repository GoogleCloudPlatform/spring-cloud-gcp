...
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/8.0.0/reference/html/index.html[Spring Framework on Google Cloud 8.0.0 (Latest)]
// {x-version-update-end}
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/7.4.4/reference/html/index.html[Spring Framework on Google Cloud 7.4.4]
