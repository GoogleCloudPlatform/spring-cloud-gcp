...
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/6.5.9/reference/html/index.html[Spring Framework on Google Cloud 6.2.3 (Latest)] - https://googleapis.dev/java/spring-cloud-gcp/6.2.3/index.html[Javadocs 6.2.3]
