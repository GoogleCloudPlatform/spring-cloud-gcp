 ...
 *
 * <p>For some methods you may specify the secret from GCP Secret Manager by URI string. The
 * following secret URI syntax is supported:
 *
 * <p>1. Long form - specify the project ID, secret ID, and version
 * sm://projects/{project-id}/secrets/{secret-id}/versions/{version-id}
 *
 * <p>2. Long form - specify project ID, secret ID, and use latest version
 * sm://projects/{project-id}/secrets/{secret-id}
 *
 * <p>3. Short form - specify project ID, secret ID, and version
 * sm://{project-id}/{secret-id}/{version-id}
 *
 * <p>4. Short form - specify secret and version, use default GCP project configured
