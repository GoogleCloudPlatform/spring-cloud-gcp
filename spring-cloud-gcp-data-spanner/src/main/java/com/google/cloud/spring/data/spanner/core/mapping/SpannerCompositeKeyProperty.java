...
public class SpannerCompositeKeyProperty implements SpannerPersistentProperty {
  ...
  public SpannerCompositeKeyProperty(
    ...
    Assert.notNull(primaryKeyColumns, "A valid array of primary key properties is required.");
  ...
  Key getId(Object entity) {
    ...
    for (SpannerPersistentProperty spannerPersistentProperty : this.primaryKeyColumns) {
      ...
      if (spannerPersistentProperty.isEmbedded()) {
        Key embeddedKeyParts =
            this.spannerPersistentEntity
  ...
  public Class<?> getType() {
    return this.primaryKeyColumns.length == 1
        ? this.primaryKeyColumns[0].getActualType()
        : Key.class;
  }
