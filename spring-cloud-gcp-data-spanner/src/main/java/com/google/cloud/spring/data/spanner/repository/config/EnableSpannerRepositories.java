...
public @interface EnableSpannerRepositories {
   ...
   * repository instance. Defaults to {@link SpannerRepositoryFactoryBean}.
   *
   ...
   * default to {@code META-INF/spanner-named-queries.properties}
   *
  ...
  /**
   * Configures the name of the {@link com.google.cloud.spring.data.spanner.core.SpannerOperations}
