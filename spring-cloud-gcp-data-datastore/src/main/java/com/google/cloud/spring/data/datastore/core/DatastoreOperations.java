...
public interface DatastoreOperations {
   ...
   *     then it will be used. Otherwise it will be attempted to be converted to an integer or
   *     string value and it will be assumed to be a root key value with the Kind determined by the
   *     entityClass. param.
  ...
  /**
   * Saves an instance of an object to Cloud Datastore. Behaves as update or insert. Ancestors can
   * be added only to entries with Key ids.
   *
  ...
  /**
   * Saves multiple instances of objects to Cloud Datastore. Behaves as update or insert. Ancestors
   * can be added only to entries with Key ids.
   *
   ...
   *
   * @param id the ID of the entity to delete. If this is actually a {@link
   *     com.google.cloud.datastore.Key} then it will be used. Otherwise it will be attempted to be
   *     converted to an integer or string value and it will be assumed to be a root key value with
   *     the Kind determined by the entityClass.
   ...
   *
   * @param ids the IDs to delete. If any of these is actually a {@link
   *     com.google.cloud.datastore.Key} then it will be used. Otherwise it will be attempted to be
   *     converted to an integer or string value and it will be assumed to be a root key value with
   *     the Kind determined by the entityClass.
   * @param entityClass the type of the
  ...
  /**
   * Delete an entity from Cloud Datastore. Deleting entities that don't exist in Cloud Datastore
   * will result in no operation.
   *
  ...
  /**
   * Find all the entities of the given IDs. If an ID is actually a {@link
   * com.google.cloud.datastore.Key} then it will be used. Otherwise it will be attempted to be
   * converted to an integer or string value and it will be assumed to be a root key value with the
   ...
   * @param <A> the row type of the query. This type can be either {@code Key} or a Cloud Datastore
   *     entity.
  ...
  /**
   * Check if the given ID belongs to an entity in Cloud Datastore. If this is actually a {@link
   * com.google.cloud.datastore.Key} then it will be used. Otherwise it will be attempted to be
   * converted to an integer or string value and it will be assumed to be a root key value with the
   * Kind determined by the entityClass.
   *
   ...
   *
   * @param operations the function that uses {@link DatastoreOperations} to perform operations in a
   *     transaction.
   ...
   * @return if an entity for a given key exists, returns the map representation of it, {@code null}
   *     otherwise
   */
   ...
   * @param id object to be used as id; if it is a Long, the value is used, otherwise it isconverted
   *     to String
   * @return created key
   */
  ...
  /**
   * Finds keys by using a Cloud Datastore query. Resulting Slice can be used to get a Pageable for
   * the next page or to determine if the next page exists.
   *
   * @param query the query to execute.
   * @param entityClass the type of object to retrieve.
  ...
  /**
   * Finds entities by using a Cloud Datastore query. Resulting Slice can be used to get a Pageable
   * for the next page or to determine if the next page exists.
   *
   * @param query the query to execute.
   * @param entityClass the type of object to retrieve.
   * @param pageable that indicates page number and page size
