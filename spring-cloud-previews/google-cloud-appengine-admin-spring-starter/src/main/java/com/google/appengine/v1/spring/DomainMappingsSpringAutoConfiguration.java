...
public class DomainMappingsSpringAutoConfiguration {
  ...
  /**
   * Provides a DomainMappingsSettings bean configured to use a DefaultCredentialsProvider and the
   * client library's default transport channel provider
   * (defaultDomainMappingsTransportChannelProvider()). It also configures the quota project ID and
