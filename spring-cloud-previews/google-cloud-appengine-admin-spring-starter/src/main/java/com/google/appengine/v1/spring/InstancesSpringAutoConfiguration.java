...
@ConditionalOnProperty(value = "com.google.appengine.v1.instances.enabled", matchIfMissing = true)
...
public class InstancesSpringAutoConfiguration {
  ...
  public TransportChannelProvider defaultInstancesTransportChannelProvider() {
    if (this.clientProperties.getUseRest()) {
      return InstancesSettings.defaultHttpJsonTransportProviderBuilder().build();
    }
    return InstancesSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a InstancesSettings bean configured to use the default credentials provider (obtained
  ...
  public InstancesSettings instancesSettings(
    ...
    if (this.clientProperties.getUseRest()) {
      clientSettingsBuilder = InstancesSettings.newHttpJsonBuilder();
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Using REST (HTTP/JSON) transport.");
      }
    } else {
      clientSettingsBuilder = InstancesSettings.newBuilder();
    }
