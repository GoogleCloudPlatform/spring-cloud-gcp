...
public class InstancesSpringAutoConfiguration {
  ...
  public InstancesSettings instancesSettings(
    ...
    if (serviceRetry != null) {
      ...
      RetrySettings debugInstanceRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.debugInstanceSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder.debugInstanceSettings().setRetrySettings(debugInstanceRetrySettings);
    ...
    Retry debugInstanceRetry = clientProperties.getDebugInstanceRetry();
    if (debugInstanceRetry != null) {
      RetrySettings debugInstanceRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.debugInstanceSettings().getRetrySettings(), debugInstanceRetry);
      clientSettingsBuilder.debugInstanceSettings().setRetrySettings(debugInstanceRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for debugInstance from properties.");
      }
    }
