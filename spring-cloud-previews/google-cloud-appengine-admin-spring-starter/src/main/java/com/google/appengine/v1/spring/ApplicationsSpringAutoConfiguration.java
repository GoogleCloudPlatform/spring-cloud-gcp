...
public class ApplicationsSpringAutoConfiguration {
  ...
  /**
   * Provides a ApplicationsSettings bean configured to use the default credentials provider
   * (obtained with applicationsCredentials()) and its default transport channel provider
