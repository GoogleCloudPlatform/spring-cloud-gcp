...
/**
 * Auto-configuration for {@link CloudControlsPartnerMonitoringClient}.
 *
...
@ConditionalOnClass(CloudControlsPartnerMonitoringClient.class)
@ConditionalOnProperty(
    value = "com.google.cloud.cloudcontrolspartner.v1.cloud-controls-partner-monitoring.enabled",
    matchIfMissing = true)
@EnableConfigurationProperties(CloudControlsPartnerMonitoringSpringProperties.class)
public class CloudControlsPartnerMonitoringSpringAutoConfiguration {
  private final CloudControlsPartnerMonitoringSpringProperties clientProperties;
  private final CredentialsProvider credentialsProvider;
  private static final Log LOGGER =
      LogFactory.getLog(CloudControlsPartnerMonitoringSpringAutoConfiguration.class);

  protected CloudControlsPartnerMonitoringSpringAutoConfiguration(
      CloudControlsPartnerMonitoringSpringProperties clientProperties,
    ...
    if (this.clientProperties.getCredentials().hasKey()) {
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Using credentials from CloudControlsPartnerMonitoring-specific configuration");
      }
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultCloudControlsPartnerMonitoringTransportChannelProvider")
  public TransportChannelProvider defaultCloudControlsPartnerMonitoringTransportChannelProvider() {
    if (this.clientProperties.getUseRest()) {
      return CloudControlsPartnerMonitoringSettings.defaultHttpJsonTransportProviderBuilder()
          .build();
    }
    return CloudControlsPartnerMonitoringSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a CloudControlsPartnerMonitoringSettings bean configured to use a
   * DefaultCredentialsProvider and the client library's default transport channel provider
   * (defaultCloudControlsPartnerMonitoringTransportChannelProvider()). It also configures the quota
