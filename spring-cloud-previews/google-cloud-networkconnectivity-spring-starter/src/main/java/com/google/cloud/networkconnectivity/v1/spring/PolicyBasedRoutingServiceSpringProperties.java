...
@ConfigurationProperties(
    "com.google.cloud.networkconnectivity.v1.spring.auto.policy-based-routing-service")
public class PolicyBasedRoutingServiceSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for createPolicyBasedRoute. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createPolicyBasedRouteRetry;
  /**
   * Allow override of retry settings at method-level for deletePolicyBasedRoute. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deletePolicyBasedRouteRetry;
  ...
  public Retry getCreatePolicyBasedRouteRetry() {
    return this.createPolicyBasedRouteRetry;
  }

  public void setCreatePolicyBasedRouteRetry(Retry createPolicyBasedRouteRetry) {
    this.createPolicyBasedRouteRetry = createPolicyBasedRouteRetry;
  }

  public Retry getDeletePolicyBasedRouteRetry() {
    return this.deletePolicyBasedRouteRetry;
  }

  public void setDeletePolicyBasedRouteRetry(Retry deletePolicyBasedRouteRetry) {
    this.deletePolicyBasedRouteRetry = deletePolicyBasedRouteRetry;
  }
}
