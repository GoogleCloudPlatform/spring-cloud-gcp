...
public class ServiceManagerSpringAutoConfiguration {
  ...
  public ServiceManagerSettings serviceManagerSettings(
    ...
    if (serviceRetry != null) {
      ...
      RetrySettings undeleteServiceRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.undeleteServiceSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .undeleteServiceSettings()
          .setRetrySettings(undeleteServiceRetrySettings);
      ...
      RetrySettings submitConfigSourceRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.submitConfigSourceSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .submitConfigSourceSettings()
          .setRetrySettings(submitConfigSourceRetrySettings);
      ...
      RetrySettings createServiceRolloutRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createServiceRolloutSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .createServiceRolloutSettings()
          .setRetrySettings(createServiceRolloutRetrySettings);
    ...
    Retry undeleteServiceRetry = clientProperties.getUndeleteServiceRetry();
    if (undeleteServiceRetry != null) {
      RetrySettings undeleteServiceRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.undeleteServiceSettings().getRetrySettings(),
              undeleteServiceRetry);
      clientSettingsBuilder
          .undeleteServiceSettings()
          .setRetrySettings(undeleteServiceRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for undeleteService from properties.");
      }
    }
    ...
    Retry submitConfigSourceRetry = clientProperties.getSubmitConfigSourceRetry();
    if (submitConfigSourceRetry != null) {
      RetrySettings submitConfigSourceRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.submitConfigSourceSettings().getRetrySettings(),
              submitConfigSourceRetry);
      clientSettingsBuilder
          .submitConfigSourceSettings()
          .setRetrySettings(submitConfigSourceRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for submitConfigSource from properties.");
      }
    }
    ...
    Retry createServiceRolloutRetry = clientProperties.getCreateServiceRolloutRetry();
    if (createServiceRolloutRetry != null) {
      RetrySettings createServiceRolloutRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createServiceRolloutSettings().getRetrySettings(),
              createServiceRolloutRetry);
      clientSettingsBuilder
          .createServiceRolloutSettings()
          .setRetrySettings(createServiceRolloutRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for createServiceRollout from properties.");
      }
    }
