...
@ConditionalOnProperty(
    value = "com.google.cloud.bigquery.datatransfer.v1.spring.auto.data-transfer-service.enabled",
    matchIfMissing = true)
...
public class DataTransferServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a DataTransferServiceClient bean configured to use the default credentials provider
   * (obtained with dataTransferServiceCredentials()) and its default transport channel provider
