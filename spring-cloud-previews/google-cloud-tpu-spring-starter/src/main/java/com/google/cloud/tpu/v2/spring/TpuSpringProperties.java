...
@ConfigurationProperties("com.google.cloud.tpu.v2.spring.auto.tpu")
public class TpuSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for createNode. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createNodeRetry;
  /**
   * Allow override of retry settings at method-level for deleteNode. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteNodeRetry;
  /**
   * Allow override of retry settings at method-level for stopNode. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry stopNodeRetry;
  /**
   * Allow override of retry settings at method-level for startNode. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry startNodeRetry;
  /**
   * Allow override of retry settings at method-level for updateNode. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry updateNodeRetry;
  /**
  ...
  public Retry getCreateNodeRetry() {
    return this.createNodeRetry;
  }

  public void setCreateNodeRetry(Retry createNodeRetry) {
    this.createNodeRetry = createNodeRetry;
  }

  public Retry getDeleteNodeRetry() {
    return this.deleteNodeRetry;
  }

  public void setDeleteNodeRetry(Retry deleteNodeRetry) {
    this.deleteNodeRetry = deleteNodeRetry;
  }

  public Retry getStopNodeRetry() {
    return this.stopNodeRetry;
  }

  public void setStopNodeRetry(Retry stopNodeRetry) {
    this.stopNodeRetry = stopNodeRetry;
  }

  public Retry getStartNodeRetry() {
    return this.startNodeRetry;
  }

  public void setStartNodeRetry(Retry startNodeRetry) {
    this.startNodeRetry = startNodeRetry;
  }

  public Retry getUpdateNodeRetry() {
    return this.updateNodeRetry;
  }

  public void setUpdateNodeRetry(Retry updateNodeRetry) {
    this.updateNodeRetry = updateNodeRetry;
  }
