...
public class EventarcSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for createTrigger. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createTriggerRetry;
  /**
   * Allow override of retry settings at method-level for updateTrigger. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry updateTriggerRetry;
  /**
   * Allow override of retry settings at method-level for deleteTrigger. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteTriggerRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for createChannel. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createChannelRetry;
  /**
   * Allow override of retry settings at method-level for updateChannel. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry updateChannelRetry;
  /**
   * Allow override of retry settings at method-level for deleteChannel. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteChannelRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for createChannelConnection. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createChannelConnectionRetry;
  /**
   * Allow override of retry settings at method-level for deleteChannelConnection. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteChannelConnectionRetry;
  /**
  ...
  public Retry getCreateTriggerRetry() {
    return this.createTriggerRetry;
  }

  public void setCreateTriggerRetry(Retry createTriggerRetry) {
    this.createTriggerRetry = createTriggerRetry;
  }

  public Retry getUpdateTriggerRetry() {
    return this.updateTriggerRetry;
  }

  public void setUpdateTriggerRetry(Retry updateTriggerRetry) {
    this.updateTriggerRetry = updateTriggerRetry;
  }

  public Retry getDeleteTriggerRetry() {
    return this.deleteTriggerRetry;
  }

  public void setDeleteTriggerRetry(Retry deleteTriggerRetry) {
    this.deleteTriggerRetry = deleteTriggerRetry;
  }
  ...
  public Retry getCreateChannelRetry() {
    return this.createChannelRetry;
  }

  public void setCreateChannelRetry(Retry createChannelRetry) {
    this.createChannelRetry = createChannelRetry;
  }

  public Retry getUpdateChannelRetry() {
    return this.updateChannelRetry;
  }

  public void setUpdateChannelRetry(Retry updateChannelRetry) {
    this.updateChannelRetry = updateChannelRetry;
  }

  public Retry getDeleteChannelRetry() {
    return this.deleteChannelRetry;
  }

  public void setDeleteChannelRetry(Retry deleteChannelRetry) {
    this.deleteChannelRetry = deleteChannelRetry;
  }
  ...
  public Retry getCreateChannelConnectionRetry() {
    return this.createChannelConnectionRetry;
  }

  public void setCreateChannelConnectionRetry(Retry createChannelConnectionRetry) {
    this.createChannelConnectionRetry = createChannelConnectionRetry;
  }

  public Retry getDeleteChannelConnectionRetry() {
    return this.deleteChannelConnectionRetry;
  }

  public void setDeleteChannelConnectionRetry(Retry deleteChannelConnectionRetry) {
    this.deleteChannelConnectionRetry = deleteChannelConnectionRetry;
  }
