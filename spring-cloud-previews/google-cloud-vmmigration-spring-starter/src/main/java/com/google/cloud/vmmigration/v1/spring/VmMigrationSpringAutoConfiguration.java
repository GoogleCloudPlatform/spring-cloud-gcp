...
public class VmMigrationSpringAutoConfiguration {
  ...
  /**
   * Provides a VmMigrationSettings bean configured to use the default credentials provider
   * (obtained with vmMigrationCredentials()) and its default transport channel provider
