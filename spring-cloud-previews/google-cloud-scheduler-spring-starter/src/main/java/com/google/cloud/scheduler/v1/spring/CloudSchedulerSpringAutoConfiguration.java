...
@ConditionalOnProperty(
    value = "com.google.cloud.scheduler.v1.spring.auto.cloud-scheduler.enabled",
    matchIfMissing = true)
...
public class CloudSchedulerSpringAutoConfiguration {
  ...
  /**
   * Provides a CloudSchedulerClient bean configured to use the default credentials provider
   * (obtained with cloudSchedulerCredentials()) and its default transport channel provider
   * (defaultCloudSchedulerTransportChannelProvider()). It also configures the quota project ID if
