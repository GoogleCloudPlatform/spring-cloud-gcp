...
public class CloudBillingSpringAutoConfiguration {
  ...
  /**
   * Provides a CloudBillingSettings bean configured to use the default credentials provider
   * (obtained with cloudBillingCredentials()) and its default transport channel provider
