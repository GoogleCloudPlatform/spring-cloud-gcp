...
@ConditionalOnProperty(
    value = "com.google.cloud.billing.v1.cloud-billing.enabled",
    matchIfMissing = true)
...
public class CloudBillingSpringAutoConfiguration {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultCloudBillingTransportChannelProvider")
  public TransportChannelProvider defaultCloudBillingTransportChannelProvider() {
    if (this.clientProperties.getUseRest()) {
      return CloudBillingSettings.defaultHttpJsonTransportProviderBuilder().build();
    }
    return CloudBillingSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a CloudBillingSettings bean configured to use a DefaultCredentialsProvider and the
   * client library's default transport channel provider
   * (defaultCloudBillingTransportChannelProvider()). It also configures the quota project ID and
   ...
   * @return a {@link CloudBillingSettings} bean configured with {@link TransportChannelProvider}
   *     bean.
   */
  @Bean
  ...
  public CloudBillingSettings cloudBillingSettings(
    ...
    if (this.clientProperties.getUseRest()) {
      clientSettingsBuilder = CloudBillingSettings.newHttpJsonBuilder();
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Using REST (HTTP/JSON) transport.");
      }
    } else {
      clientSettingsBuilder = CloudBillingSettings.newBuilder();
    }
   ...
   *
   * @param cloudBillingSettings settings to configure an instance of client bean.
   * @return a {@link CloudBillingClient} bean configured with {@link CloudBillingSettings}
   */
  @Bean
  @ConditionalOnMissingBean
