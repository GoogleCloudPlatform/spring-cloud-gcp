...
@ConditionalOnProperty(
    value = "com.google.cloud.billing.v1.spring.auto.cloud-catalog.enabled",
    matchIfMissing = true)
...
public class CloudCatalogSpringAutoConfiguration {
  ...
  /**
   * Provides a CloudCatalogClient bean configured to use the default credentials provider (obtained
   * with cloudCatalogCredentials()) and its default transport channel provider
