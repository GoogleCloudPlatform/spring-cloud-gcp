...
public class CloudCatalogSpringAutoConfiguration {
  ...
  /**
   * Provides a CloudCatalogSettings bean configured to use the default credentials provider
   * (obtained with cloudCatalogCredentials()) and its default transport channel provider
   * (defaultCloudCatalogTransportChannelProvider()). It also configures the quota project ID if
