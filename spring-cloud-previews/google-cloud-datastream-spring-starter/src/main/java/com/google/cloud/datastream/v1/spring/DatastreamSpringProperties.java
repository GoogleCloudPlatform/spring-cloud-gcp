...
public class DatastreamSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for createStream. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createStreamRetry;
  /**
   * Allow override of retry settings at method-level for updateStream. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry updateStreamRetry;
  /**
   * Allow override of retry settings at method-level for deleteStream. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteStreamRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for createPrivateConnection. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createPrivateConnectionRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for deletePrivateConnection. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deletePrivateConnectionRetry;
  /**
   * Allow override of retry settings at method-level for createRoute. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createRouteRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for deleteRoute. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteRouteRetry;
  /**
  ...
  public Retry getCreateStreamRetry() {
    return this.createStreamRetry;
  }

  public void setCreateStreamRetry(Retry createStreamRetry) {
    this.createStreamRetry = createStreamRetry;
  }

  public Retry getUpdateStreamRetry() {
    return this.updateStreamRetry;
  }

  public void setUpdateStreamRetry(Retry updateStreamRetry) {
    this.updateStreamRetry = updateStreamRetry;
  }

  public Retry getDeleteStreamRetry() {
    return this.deleteStreamRetry;
  }

  public void setDeleteStreamRetry(Retry deleteStreamRetry) {
    this.deleteStreamRetry = deleteStreamRetry;
  }
  ...
  public Retry getCreatePrivateConnectionRetry() {
    return this.createPrivateConnectionRetry;
  }

  public void setCreatePrivateConnectionRetry(Retry createPrivateConnectionRetry) {
    this.createPrivateConnectionRetry = createPrivateConnectionRetry;
  }
  ...
  public Retry getDeletePrivateConnectionRetry() {
    return this.deletePrivateConnectionRetry;
  }

  public void setDeletePrivateConnectionRetry(Retry deletePrivateConnectionRetry) {
    this.deletePrivateConnectionRetry = deletePrivateConnectionRetry;
  }

  public Retry getCreateRouteRetry() {
    return this.createRouteRetry;
  }

  public void setCreateRouteRetry(Retry createRouteRetry) {
    this.createRouteRetry = createRouteRetry;
  }
  ...
  public Retry getDeleteRouteRetry() {
    return this.deleteRouteRetry;
  }

  public void setDeleteRouteRetry(Retry deleteRouteRetry) {
    this.deleteRouteRetry = deleteRouteRetry;
  }
