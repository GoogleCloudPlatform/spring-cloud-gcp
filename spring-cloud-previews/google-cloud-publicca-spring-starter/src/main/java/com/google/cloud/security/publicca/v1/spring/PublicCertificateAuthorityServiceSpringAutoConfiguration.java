...
/**
 * Auto-configuration for {@link PublicCertificateAuthorityServiceClient}.
 *
...
@ConditionalOnClass(PublicCertificateAuthorityServiceClient.class)
@ConditionalOnProperty(
    value = "com.google.cloud.security.publicca.v1.public-certificate-authority-service.enabled",
    matchIfMissing = true)
...
public class PublicCertificateAuthorityServiceSpringAutoConfiguration {
  private final PublicCertificateAuthorityServiceSpringProperties clientProperties;
  private final CredentialsProvider credentialsProvider;
  private static final Log LOGGER =
      LogFactory.getLog(PublicCertificateAuthorityServiceSpringAutoConfiguration.class);

  protected PublicCertificateAuthorityServiceSpringAutoConfiguration(
      PublicCertificateAuthorityServiceSpringProperties clientProperties,
    ...
    if (this.clientProperties.getCredentials().hasKey()) {
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Using credentials from PublicCertificateAuthorityService-specific configuration");
      }
  ...
  @ConditionalOnMissingBean(
      name = "defaultPublicCertificateAuthorityServiceTransportChannelProvider")
  public TransportChannelProvider
      defaultPublicCertificateAuthorityServiceTransportChannelProvider() {
    if (this.clientProperties.getUseRest()) {
      return PublicCertificateAuthorityServiceSettings.defaultHttpJsonTransportProviderBuilder()
          .build();
    }
    return PublicCertificateAuthorityServiceSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a PublicCertificateAuthorityServiceSettings bean configured to use a
   * DefaultCredentialsProvider and the client library's default transport channel provider
   * (defaultPublicCertificateAuthorityServiceTransportChannelProvider()). It also configures the
