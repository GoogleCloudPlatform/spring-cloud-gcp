...
public class TextToSpeechSpringAutoConfiguration {
  ...
  /**
   * Provides a TextToSpeechSettings bean configured to use a DefaultCredentialsProvider and the
   * client library's default transport channel provider
   * (defaultTextToSpeechTransportChannelProvider()). It also configures the quota project ID and
