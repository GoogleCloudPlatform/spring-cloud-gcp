...
@ConditionalOnProperty(
    value = "com.google.cloud.texttospeech.v1.text-to-speech.enabled",
    matchIfMissing = true)
@EnableConfigurationProperties(TextToSpeechSpringProperties.class)
public class TextToSpeechSpringAutoConfiguration {
  ...
  protected TextToSpeechSpringAutoConfiguration(
      TextToSpeechSpringProperties clientProperties, CredentialsProvider credentialsProvider)
      throws IOException {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultTextToSpeechTransportChannelProvider")
  public TransportChannelProvider defaultTextToSpeechTransportChannelProvider() {
    if (this.clientProperties.getUseRest()) {
      return TextToSpeechSettings.defaultHttpJsonTransportProviderBuilder().build();
    }
    return TextToSpeechSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a TextToSpeechSettings bean configured to use the default credentials provider
   * (obtained with textToSpeechCredentials()) and its default transport channel provider
