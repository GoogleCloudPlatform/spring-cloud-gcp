...
@ConfigurationProperties("com.google.cloud.servicedirectory.v1.lookup-service")
public class LookupServiceSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for resolveService. If defined, this takes
  ...
  public Retry getResolveServiceRetry() {
    return this.resolveServiceRetry;
  }
