...
@ConditionalOnProperty(
    value = "com.google.cloud.shell.v1.cloud-shell-service.enabled",
    matchIfMissing = true)
...
public class CloudShellServiceSpringAutoConfiguration {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultCloudShellServiceTransportChannelProvider")
  public TransportChannelProvider defaultCloudShellServiceTransportChannelProvider() {
    if (this.clientProperties.getUseRest()) {
      return CloudShellServiceSettings.defaultHttpJsonTransportProviderBuilder().build();
    }
    return CloudShellServiceSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a CloudShellServiceSettings bean configured to use the default credentials provider
