...
@ConfigurationProperties("com.google.cloud.discoveryengine.v1.site-search-engine-service")
public class SiteSearchEngineServiceSpringProperties implements CredentialsSupplier {
   ...
   */
  @NestedConfigurationProperty private Retry fetchDomainVerificationStatusRetry;
  ...
  public Retry getGetSiteSearchEngineRetry() {
    return this.getSiteSearchEngineRetry;
  }

  public void setGetSiteSearchEngineRetry(Retry getSiteSearchEngineRetry) {
    this.getSiteSearchEngineRetry = getSiteSearchEngineRetry;
  }

  public Retry getGetTargetSiteRetry() {
    return this.getTargetSiteRetry;
  }

  public void setGetTargetSiteRetry(Retry getTargetSiteRetry) {
    this.getTargetSiteRetry = getTargetSiteRetry;
  }

  public Retry getListTargetSitesRetry() {
    return this.listTargetSitesRetry;
  }
  ...
  public Retry getFetchDomainVerificationStatusRetry() {
    return this.fetchDomainVerificationStatusRetry;
  }

  public void setFetchDomainVerificationStatusRetry(Retry fetchDomainVerificationStatusRetry) {
    this.fetchDomainVerificationStatusRetry = fetchDomainVerificationStatusRetry;
  }
}
