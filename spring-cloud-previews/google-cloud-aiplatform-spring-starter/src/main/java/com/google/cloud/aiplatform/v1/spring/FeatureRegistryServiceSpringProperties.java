...
@ConfigurationProperties("com.google.cloud.aiplatform.v1.feature-registry-service")
public class FeatureRegistryServiceSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for getFeatureGroup. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry getFeatureGroupRetry;
  /**
   * Allow override of retry settings at method-level for listFeatureGroups. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry listFeatureGroupsRetry;
  /**
  ...
  public Retry getGetFeatureGroupRetry() {
    return this.getFeatureGroupRetry;
  }

  public void setGetFeatureGroupRetry(Retry getFeatureGroupRetry) {
    this.getFeatureGroupRetry = getFeatureGroupRetry;
  }

  public Retry getListFeatureGroupsRetry() {
    return this.listFeatureGroupsRetry;
  }

  public void setListFeatureGroupsRetry(Retry listFeatureGroupsRetry) {
    this.listFeatureGroupsRetry = listFeatureGroupsRetry;
  }
