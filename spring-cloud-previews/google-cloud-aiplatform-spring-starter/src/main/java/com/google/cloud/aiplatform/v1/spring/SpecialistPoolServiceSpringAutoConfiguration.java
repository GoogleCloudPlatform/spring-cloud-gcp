...
@ConditionalOnProperty(
    value = "com.google.cloud.aiplatform.v1.specialist-pool-service.enabled",
    matchIfMissing = true)
...
public class SpecialistPoolServiceSpringAutoConfiguration {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultSpecialistPoolServiceTransportChannelProvider")
  ...
  /**
   * Provides a SpecialistPoolServiceSettings bean configured to use the default credentials
   * provider (obtained with specialistPoolServiceCredentials()) and its default transport channel
   * provider (defaultSpecialistPoolServiceTransportChannelProvider()). It also configures the quota
   ...
   * @return a {@link SpecialistPoolServiceSettings} bean configured with {@link
   ...
   *
   * @param specialistPoolServiceSettings settings to configure an instance of client bean.
   * @return a {@link SpecialistPoolServiceClient} bean configured with {@link
