...
@ConditionalOnProperty(
    value = "com.google.cloud.aiplatform.v1.spring.auto.tensorboard-service.enabled",
    matchIfMissing = true)
...
public class TensorboardServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a TensorboardServiceClient bean configured to use the default credentials provider
   * (obtained with tensorboardServiceCredentials()) and its default transport channel provider
  ...
  public TensorboardServiceSettings tensorboardServiceSettings(
    ...
    if (serviceRetry != null) {
      RetrySettings createTensorboardRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createTensorboardSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .createTensorboardSettings()
          .setRetrySettings(createTensorboardRetrySettings);
      ...
      RetrySettings updateTensorboardRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.updateTensorboardSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .updateTensorboardSettings()
          .setRetrySettings(updateTensorboardRetrySettings);
      ...
      RetrySettings deleteTensorboardRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteTensorboardSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .deleteTensorboardSettings()
          .setRetrySettings(deleteTensorboardRetrySettings);
      ...
      RetrySettings deleteTensorboardExperimentRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteTensorboardExperimentSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .deleteTensorboardExperimentSettings()
          .setRetrySettings(deleteTensorboardExperimentRetrySettings);
      ...
      RetrySettings deleteTensorboardRunRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteTensorboardRunSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .deleteTensorboardRunSettings()
          .setRetrySettings(deleteTensorboardRunRetrySettings);
      ...
      RetrySettings deleteTensorboardTimeSeriesRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteTensorboardTimeSeriesSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .deleteTensorboardTimeSeriesSettings()
          .setRetrySettings(deleteTensorboardTimeSeriesRetrySettings);
      ...
      RetrySettings readTensorboardBlobDataRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.readTensorboardBlobDataSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .readTensorboardBlobDataSettings()
          .setRetrySettings(readTensorboardBlobDataRetrySettings);
    ...
    Retry createTensorboardRetry = clientProperties.getCreateTensorboardRetry();
    if (createTensorboardRetry != null) {
      RetrySettings createTensorboardRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createTensorboardSettings().getRetrySettings(),
              createTensorboardRetry);
      clientSettingsBuilder
          .createTensorboardSettings()
          .setRetrySettings(createTensorboardRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for createTensorboard from properties.");
      }
    }
    ...
    Retry updateTensorboardRetry = clientProperties.getUpdateTensorboardRetry();
    if (updateTensorboardRetry != null) {
      RetrySettings updateTensorboardRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.updateTensorboardSettings().getRetrySettings(),
              updateTensorboardRetry);
      clientSettingsBuilder
          .updateTensorboardSettings()
          .setRetrySettings(updateTensorboardRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for updateTensorboard from properties.");
      }
    }
    ...
    Retry deleteTensorboardRetry = clientProperties.getDeleteTensorboardRetry();
    if (deleteTensorboardRetry != null) {
      RetrySettings deleteTensorboardRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteTensorboardSettings().getRetrySettings(),
              deleteTensorboardRetry);
      clientSettingsBuilder
          .deleteTensorboardSettings()
          .setRetrySettings(deleteTensorboardRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deleteTensorboard from properties.");
      }
    }
    ...
    Retry deleteTensorboardExperimentRetry = clientProperties.getDeleteTensorboardExperimentRetry();
    if (deleteTensorboardExperimentRetry != null) {
      RetrySettings deleteTensorboardExperimentRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteTensorboardExperimentSettings().getRetrySettings(),
              deleteTensorboardExperimentRetry);
      clientSettingsBuilder
          .deleteTensorboardExperimentSettings()
          .setRetrySettings(deleteTensorboardExperimentRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deleteTensorboardExperiment from properties.");
      }
    }
    ...
    Retry deleteTensorboardRunRetry = clientProperties.getDeleteTensorboardRunRetry();
    if (deleteTensorboardRunRetry != null) {
      RetrySettings deleteTensorboardRunRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteTensorboardRunSettings().getRetrySettings(),
              deleteTensorboardRunRetry);
      clientSettingsBuilder
          .deleteTensorboardRunSettings()
          .setRetrySettings(deleteTensorboardRunRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deleteTensorboardRun from properties.");
      }
    }
    ...
    Retry deleteTensorboardTimeSeriesRetry = clientProperties.getDeleteTensorboardTimeSeriesRetry();
    if (deleteTensorboardTimeSeriesRetry != null) {
      RetrySettings deleteTensorboardTimeSeriesRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteTensorboardTimeSeriesSettings().getRetrySettings(),
              deleteTensorboardTimeSeriesRetry);
      clientSettingsBuilder
          .deleteTensorboardTimeSeriesSettings()
          .setRetrySettings(deleteTensorboardTimeSeriesRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deleteTensorboardTimeSeries from properties.");
      }
    }
    ...
    Retry readTensorboardBlobDataRetry = clientProperties.getReadTensorboardBlobDataRetry();
    if (readTensorboardBlobDataRetry != null) {
      RetrySettings readTensorboardBlobDataRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.readTensorboardBlobDataSettings().getRetrySettings(),
              readTensorboardBlobDataRetry);
      clientSettingsBuilder
          .readTensorboardBlobDataSettings()
          .setRetrySettings(readTensorboardBlobDataRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for readTensorboardBlobData from properties.");
      }
    }
