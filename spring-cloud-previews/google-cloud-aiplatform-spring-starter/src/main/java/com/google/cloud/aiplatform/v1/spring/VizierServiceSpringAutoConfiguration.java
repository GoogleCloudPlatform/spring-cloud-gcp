...
@ConditionalOnProperty(
    value = "com.google.cloud.aiplatform.v1.spring.auto.vizier-service.enabled",
    matchIfMissing = true)
...
public class VizierServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a VizierServiceClient bean configured to use the default credentials provider
  ...
  public VizierServiceSettings vizierServiceSettings(
      ...
      throws IOException {
    VizierServiceSettings.Builder clientSettingsBuilder =
    ...
    if (serviceRetry != null) {
      ...
      RetrySettings suggestTrialsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.suggestTrialsSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder.suggestTrialsSettings().setRetrySettings(suggestTrialsRetrySettings);
      ...
      RetrySettings checkTrialEarlyStoppingStateRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.checkTrialEarlyStoppingStateSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .checkTrialEarlyStoppingStateSettings()
          .setRetrySettings(checkTrialEarlyStoppingStateRetrySettings);
    ...
    Retry suggestTrialsRetry = clientProperties.getSuggestTrialsRetry();
    if (suggestTrialsRetry != null) {
      RetrySettings suggestTrialsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.suggestTrialsSettings().getRetrySettings(), suggestTrialsRetry);
      clientSettingsBuilder.suggestTrialsSettings().setRetrySettings(suggestTrialsRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for suggestTrials from properties.");
      }
    }
    ...
    Retry checkTrialEarlyStoppingStateRetry =
        clientProperties.getCheckTrialEarlyStoppingStateRetry();
    if (checkTrialEarlyStoppingStateRetry != null) {
      RetrySettings checkTrialEarlyStoppingStateRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.checkTrialEarlyStoppingStateSettings().getRetrySettings(),
              checkTrialEarlyStoppingStateRetry);
      clientSettingsBuilder
          .checkTrialEarlyStoppingStateSettings()
          .setRetrySettings(checkTrialEarlyStoppingStateRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for checkTrialEarlyStoppingState from properties.");
      }
    }
