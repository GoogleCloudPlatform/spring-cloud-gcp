...
@ConfigurationProperties("com.google.cloud.aiplatform.v1.spring.auto.tensorboard-service")
public class TensorboardServiceSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for createTensorboard. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createTensorboardRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for updateTensorboard. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry updateTensorboardRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for deleteTensorboard. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteTensorboardRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for deleteTensorboardExperiment. If defined,
   * this takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteTensorboardExperimentRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for deleteTensorboardRun. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteTensorboardRunRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for deleteTensorboardTimeSeries. If defined,
   * this takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteTensorboardTimeSeriesRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for readTensorboardBlobData. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry readTensorboardBlobDataRetry;
  /**
  ...
  public Retry getCreateTensorboardRetry() {
    return this.createTensorboardRetry;
  }

  public void setCreateTensorboardRetry(Retry createTensorboardRetry) {
    this.createTensorboardRetry = createTensorboardRetry;
  }
  ...
  public Retry getUpdateTensorboardRetry() {
    return this.updateTensorboardRetry;
  }

  public void setUpdateTensorboardRetry(Retry updateTensorboardRetry) {
    this.updateTensorboardRetry = updateTensorboardRetry;
  }
  ...
  public Retry getDeleteTensorboardRetry() {
    return this.deleteTensorboardRetry;
  }

  public void setDeleteTensorboardRetry(Retry deleteTensorboardRetry) {
    this.deleteTensorboardRetry = deleteTensorboardRetry;
  }
  ...
  public Retry getDeleteTensorboardExperimentRetry() {
    return this.deleteTensorboardExperimentRetry;
  }

  public void setDeleteTensorboardExperimentRetry(Retry deleteTensorboardExperimentRetry) {
    this.deleteTensorboardExperimentRetry = deleteTensorboardExperimentRetry;
  }
  ...
  public Retry getDeleteTensorboardRunRetry() {
    return this.deleteTensorboardRunRetry;
  }

  public void setDeleteTensorboardRunRetry(Retry deleteTensorboardRunRetry) {
    this.deleteTensorboardRunRetry = deleteTensorboardRunRetry;
  }
  ...
  public Retry getDeleteTensorboardTimeSeriesRetry() {
    return this.deleteTensorboardTimeSeriesRetry;
  }

  public void setDeleteTensorboardTimeSeriesRetry(Retry deleteTensorboardTimeSeriesRetry) {
    this.deleteTensorboardTimeSeriesRetry = deleteTensorboardTimeSeriesRetry;
  }
  ...
  public Retry getReadTensorboardBlobDataRetry() {
    return this.readTensorboardBlobDataRetry;
  }

  public void setReadTensorboardBlobDataRetry(Retry readTensorboardBlobDataRetry) {
    this.readTensorboardBlobDataRetry = readTensorboardBlobDataRetry;
  }
