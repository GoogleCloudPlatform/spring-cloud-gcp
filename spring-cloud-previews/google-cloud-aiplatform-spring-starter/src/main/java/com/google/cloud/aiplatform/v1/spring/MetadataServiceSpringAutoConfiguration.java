...
@ConditionalOnProperty(
    value = "com.google.cloud.aiplatform.v1.spring.auto.metadata-service.enabled",
    matchIfMissing = true)
...
public class MetadataServiceSpringAutoConfiguration {
  ...
  public MetadataServiceSettings metadataServiceSettings(
    ...
    if (serviceRetry != null) {
      RetrySettings createMetadataStoreRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createMetadataStoreSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .createMetadataStoreSettings()
          .setRetrySettings(createMetadataStoreRetrySettings);
      ...
      RetrySettings deleteMetadataStoreRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteMetadataStoreSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .deleteMetadataStoreSettings()
          .setRetrySettings(deleteMetadataStoreRetrySettings);
      ...
      RetrySettings deleteArtifactRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteArtifactSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder.deleteArtifactSettings().setRetrySettings(deleteArtifactRetrySettings);

      RetrySettings purgeArtifactsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.purgeArtifactsSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder.purgeArtifactsSettings().setRetrySettings(purgeArtifactsRetrySettings);
      ...
      RetrySettings purgeContextsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.purgeContextsSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder.purgeContextsSettings().setRetrySettings(purgeContextsRetrySettings);
      ...
      RetrySettings purgeExecutionsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.purgeExecutionsSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .purgeExecutionsSettings()
          .setRetrySettings(purgeExecutionsRetrySettings);
    ...
    Retry createMetadataStoreRetry = clientProperties.getCreateMetadataStoreRetry();
    if (createMetadataStoreRetry != null) {
      RetrySettings createMetadataStoreRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createMetadataStoreSettings().getRetrySettings(),
              createMetadataStoreRetry);
      clientSettingsBuilder
          .createMetadataStoreSettings()
          .setRetrySettings(createMetadataStoreRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for createMetadataStore from properties.");
      }
    }
    ...
    Retry deleteMetadataStoreRetry = clientProperties.getDeleteMetadataStoreRetry();
    if (deleteMetadataStoreRetry != null) {
      RetrySettings deleteMetadataStoreRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteMetadataStoreSettings().getRetrySettings(),
              deleteMetadataStoreRetry);
      clientSettingsBuilder
          .deleteMetadataStoreSettings()
          .setRetrySettings(deleteMetadataStoreRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deleteMetadataStore from properties.");
      }
    }
    ...
    Retry deleteArtifactRetry = clientProperties.getDeleteArtifactRetry();
    if (deleteArtifactRetry != null) {
      RetrySettings deleteArtifactRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteArtifactSettings().getRetrySettings(),
              deleteArtifactRetry);
      clientSettingsBuilder.deleteArtifactSettings().setRetrySettings(deleteArtifactRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for deleteArtifact from properties.");
      }
    }
    Retry purgeArtifactsRetry = clientProperties.getPurgeArtifactsRetry();
    if (purgeArtifactsRetry != null) {
      RetrySettings purgeArtifactsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.purgeArtifactsSettings().getRetrySettings(),
              purgeArtifactsRetry);
      clientSettingsBuilder.purgeArtifactsSettings().setRetrySettings(purgeArtifactsRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for purgeArtifacts from properties.");
      }
    }
    ...
    Retry purgeContextsRetry = clientProperties.getPurgeContextsRetry();
    if (purgeContextsRetry != null) {
      RetrySettings purgeContextsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.purgeContextsSettings().getRetrySettings(), purgeContextsRetry);
      clientSettingsBuilder.purgeContextsSettings().setRetrySettings(purgeContextsRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for purgeContexts from properties.");
      }
    }
    ...
    Retry purgeExecutionsRetry = clientProperties.getPurgeExecutionsRetry();
    if (purgeExecutionsRetry != null) {
      RetrySettings purgeExecutionsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.purgeExecutionsSettings().getRetrySettings(),
              purgeExecutionsRetry);
      clientSettingsBuilder
          .purgeExecutionsSettings()
          .setRetrySettings(purgeExecutionsRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for purgeExecutions from properties.");
      }
    }
