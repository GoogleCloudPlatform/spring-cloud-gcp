...
@ConditionalOnProperty(
    value = "com.google.cloud.aiplatform.v1.spring.auto.pipeline-service.enabled",
    matchIfMissing = true)
...
public class PipelineServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a PipelineServiceClient bean configured to use the default credentials provider
   * (obtained with pipelineServiceCredentials()) and its default transport channel provider
   * (defaultPipelineServiceTransportChannelProvider()). It also configures the quota project ID if
  ...
  public PipelineServiceSettings pipelineServiceSettings(
      ...
      throws IOException {
    PipelineServiceSettings.Builder clientSettingsBuilder =
    ...
    if (serviceRetry != null) {
      ...
      RetrySettings deleteTrainingPipelineRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteTrainingPipelineSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .deleteTrainingPipelineSettings()
          .setRetrySettings(deleteTrainingPipelineRetrySettings);
      ...
      RetrySettings deletePipelineJobRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deletePipelineJobSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .deletePipelineJobSettings()
          .setRetrySettings(deletePipelineJobRetrySettings);
    ...
    Retry deleteTrainingPipelineRetry = clientProperties.getDeleteTrainingPipelineRetry();
    if (deleteTrainingPipelineRetry != null) {
      RetrySettings deleteTrainingPipelineRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteTrainingPipelineSettings().getRetrySettings(),
              deleteTrainingPipelineRetry);
      clientSettingsBuilder
          .deleteTrainingPipelineSettings()
          .setRetrySettings(deleteTrainingPipelineRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deleteTrainingPipeline from properties.");
      }
    }
    ...
    Retry deletePipelineJobRetry = clientProperties.getDeletePipelineJobRetry();
    if (deletePipelineJobRetry != null) {
      RetrySettings deletePipelineJobRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deletePipelineJobSettings().getRetrySettings(),
              deletePipelineJobRetry);
      clientSettingsBuilder
          .deletePipelineJobSettings()
          .setRetrySettings(deletePipelineJobRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deletePipelineJob from properties.");
      }
    }
