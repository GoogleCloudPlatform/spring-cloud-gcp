...
@ConditionalOnProperty(
    value = "com.google.cloud.aiplatform.v1.spring.auto.job-service.enabled",
    matchIfMissing = true)
...
public class JobServiceSpringAutoConfiguration {
  ...
  public JobServiceSettings jobServiceSettings(
    ...
    if (serviceRetry != null) {
      ...
      RetrySettings deleteCustomJobRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteCustomJobSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .deleteCustomJobSettings()
          .setRetrySettings(deleteCustomJobRetrySettings);
      ...
      RetrySettings deleteDataLabelingJobRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteDataLabelingJobSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .deleteDataLabelingJobSettings()
          .setRetrySettings(deleteDataLabelingJobRetrySettings);
      ...
      RetrySettings deleteHyperparameterTuningJobRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteHyperparameterTuningJobSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .deleteHyperparameterTuningJobSettings()
          .setRetrySettings(deleteHyperparameterTuningJobRetrySettings);
      ...
      RetrySettings deleteBatchPredictionJobRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteBatchPredictionJobSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .deleteBatchPredictionJobSettings()
          .setRetrySettings(deleteBatchPredictionJobRetrySettings);
      ...
      RetrySettings updateModelDeploymentMonitoringJobRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.updateModelDeploymentMonitoringJobSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .updateModelDeploymentMonitoringJobSettings()
          .setRetrySettings(updateModelDeploymentMonitoringJobRetrySettings);

      RetrySettings deleteModelDeploymentMonitoringJobRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteModelDeploymentMonitoringJobSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .deleteModelDeploymentMonitoringJobSettings()
          .setRetrySettings(deleteModelDeploymentMonitoringJobRetrySettings);
    ...
    Retry deleteCustomJobRetry = clientProperties.getDeleteCustomJobRetry();
    if (deleteCustomJobRetry != null) {
      RetrySettings deleteCustomJobRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteCustomJobSettings().getRetrySettings(),
              deleteCustomJobRetry);
      clientSettingsBuilder
          .deleteCustomJobSettings()
          .setRetrySettings(deleteCustomJobRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for deleteCustomJob from properties.");
      }
    }
    ...
    Retry deleteDataLabelingJobRetry = clientProperties.getDeleteDataLabelingJobRetry();
    if (deleteDataLabelingJobRetry != null) {
      RetrySettings deleteDataLabelingJobRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteDataLabelingJobSettings().getRetrySettings(),
              deleteDataLabelingJobRetry);
      clientSettingsBuilder
          .deleteDataLabelingJobSettings()
          .setRetrySettings(deleteDataLabelingJobRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deleteDataLabelingJob from properties.");
      }
    }
    ...
    Retry deleteHyperparameterTuningJobRetry =
        clientProperties.getDeleteHyperparameterTuningJobRetry();
    if (deleteHyperparameterTuningJobRetry != null) {
      RetrySettings deleteHyperparameterTuningJobRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteHyperparameterTuningJobSettings().getRetrySettings(),
              deleteHyperparameterTuningJobRetry);
      clientSettingsBuilder
          .deleteHyperparameterTuningJobSettings()
          .setRetrySettings(deleteHyperparameterTuningJobRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deleteHyperparameterTuningJob from properties.");
      }
    }
    ...
    Retry deleteBatchPredictionJobRetry = clientProperties.getDeleteBatchPredictionJobRetry();
    if (deleteBatchPredictionJobRetry != null) {
      RetrySettings deleteBatchPredictionJobRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteBatchPredictionJobSettings().getRetrySettings(),
              deleteBatchPredictionJobRetry);
      clientSettingsBuilder
          .deleteBatchPredictionJobSettings()
          .setRetrySettings(deleteBatchPredictionJobRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deleteBatchPredictionJob from properties.");
      }
    }
    ...
    Retry updateModelDeploymentMonitoringJobRetry =
        clientProperties.getUpdateModelDeploymentMonitoringJobRetry();
    if (updateModelDeploymentMonitoringJobRetry != null) {
      RetrySettings updateModelDeploymentMonitoringJobRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.updateModelDeploymentMonitoringJobSettings().getRetrySettings(),
              updateModelDeploymentMonitoringJobRetry);
      clientSettingsBuilder
          .updateModelDeploymentMonitoringJobSettings()
          .setRetrySettings(updateModelDeploymentMonitoringJobRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for updateModelDeploymentMonitoringJob from properties.");
      }
    }
    Retry deleteModelDeploymentMonitoringJobRetry =
        clientProperties.getDeleteModelDeploymentMonitoringJobRetry();
    if (deleteModelDeploymentMonitoringJobRetry != null) {
      RetrySettings deleteModelDeploymentMonitoringJobRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteModelDeploymentMonitoringJobSettings().getRetrySettings(),
              deleteModelDeploymentMonitoringJobRetry);
      clientSettingsBuilder
          .deleteModelDeploymentMonitoringJobSettings()
          .setRetrySettings(deleteModelDeploymentMonitoringJobRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deleteModelDeploymentMonitoringJob from properties.");
      }
    }
