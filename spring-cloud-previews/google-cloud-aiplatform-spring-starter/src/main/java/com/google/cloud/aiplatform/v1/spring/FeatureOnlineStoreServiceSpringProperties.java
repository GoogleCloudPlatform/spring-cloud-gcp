...
@ConfigurationProperties("com.google.cloud.aiplatform.v1.feature-online-store-service")
public class FeatureOnlineStoreServiceSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for fetchFeatureValues. If defined, this takes
  ...
  public Retry getFetchFeatureValuesRetry() {
    return this.fetchFeatureValuesRetry;
  }
