...
@ConditionalOnProperty(
    value = "com.google.cloud.aiplatform.v1.index-endpoint-service.enabled",
    matchIfMissing = true)
...
public class IndexEndpointServiceSpringAutoConfiguration {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultIndexEndpointServiceTransportChannelProvider")
  ...
  /**
   * Provides a IndexEndpointServiceSettings bean configured to use a DefaultCredentialsProvider and
   ...
   * @return a {@link IndexEndpointServiceSettings} bean configured with {@link
   ...
   *
   * @param indexEndpointServiceSettings settings to configure an instance of client bean.
   * @return a {@link IndexEndpointServiceClient} bean configured with {@link
