...
@ConfigurationProperties("com.google.cloud.aiplatform.v1.spring.auto.endpoint-service")
public class EndpointServiceSpringProperties implements CredentialsSupplier {
