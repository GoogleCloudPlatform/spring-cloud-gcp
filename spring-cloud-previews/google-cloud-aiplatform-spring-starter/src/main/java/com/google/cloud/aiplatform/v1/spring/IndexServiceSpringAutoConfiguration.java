...
@ConditionalOnProperty(
    value = "com.google.cloud.aiplatform.v1.spring.auto.index-service.enabled",
    matchIfMissing = true)
...
public class IndexServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a IndexServiceClient bean configured to use the default credentials provider (obtained
   * with indexServiceCredentials()) and its default transport channel provider
  ...
  public IndexServiceSettings indexServiceSettings(
      ...
      throws IOException {
    IndexServiceSettings.Builder clientSettingsBuilder =
    ...
    if (serviceRetry != null) {
      RetrySettings createIndexRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createIndexSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder.createIndexSettings().setRetrySettings(createIndexRetrySettings);
      ...
      RetrySettings updateIndexRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.updateIndexSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder.updateIndexSettings().setRetrySettings(updateIndexRetrySettings);

      RetrySettings deleteIndexRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteIndexSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder.deleteIndexSettings().setRetrySettings(deleteIndexRetrySettings);
    ...
    Retry createIndexRetry = clientProperties.getCreateIndexRetry();
    if (createIndexRetry != null) {
      RetrySettings createIndexRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createIndexSettings().getRetrySettings(), createIndexRetry);
      clientSettingsBuilder.createIndexSettings().setRetrySettings(createIndexRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for createIndex from properties.");
      }
    }
    ...
    Retry updateIndexRetry = clientProperties.getUpdateIndexRetry();
    if (updateIndexRetry != null) {
      RetrySettings updateIndexRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.updateIndexSettings().getRetrySettings(), updateIndexRetry);
      clientSettingsBuilder.updateIndexSettings().setRetrySettings(updateIndexRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for updateIndex from properties.");
      }
    }
    Retry deleteIndexRetry = clientProperties.getDeleteIndexRetry();
    if (deleteIndexRetry != null) {
      RetrySettings deleteIndexRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteIndexSettings().getRetrySettings(), deleteIndexRetry);
      clientSettingsBuilder.deleteIndexSettings().setRetrySettings(deleteIndexRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for deleteIndex from properties.");
      }
    }
