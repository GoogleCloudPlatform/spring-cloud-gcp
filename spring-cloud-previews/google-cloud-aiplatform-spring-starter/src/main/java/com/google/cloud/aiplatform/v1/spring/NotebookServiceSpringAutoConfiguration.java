...
@ConditionalOnProperty(
    value = "com.google.cloud.aiplatform.v1.notebook-service.enabled",
    matchIfMissing = true)
...
public class NotebookServiceSpringAutoConfiguration {
  ...
  public NotebookServiceSettings notebookServiceSettings(
    ...
    if (serviceRetry != null) {
      RetrySettings getNotebookRuntimeTemplateRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.getNotebookRuntimeTemplateSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .getNotebookRuntimeTemplateSettings()
          .setRetrySettings(getNotebookRuntimeTemplateRetrySettings);

      RetrySettings listNotebookRuntimeTemplatesRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.listNotebookRuntimeTemplatesSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
      ...
      clientSettingsBuilder
          ...
          .setRetrySettings(getNotebookRuntimeRetrySettings);

      RetrySettings listNotebookRuntimesRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.listNotebookRuntimesSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
    ...
    Retry getNotebookRuntimeTemplateRetry = clientProperties.getGetNotebookRuntimeTemplateRetry();
    if (getNotebookRuntimeTemplateRetry != null) {
      RetrySettings getNotebookRuntimeTemplateRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.getNotebookRuntimeTemplateSettings().getRetrySettings(),
              getNotebookRuntimeTemplateRetry);
      clientSettingsBuilder
          .getNotebookRuntimeTemplateSettings()
          .setRetrySettings(getNotebookRuntimeTemplateRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for getNotebookRuntimeTemplate from properties.");
      }
    }
    Retry listNotebookRuntimeTemplatesRetry =
        clientProperties.getListNotebookRuntimeTemplatesRetry();
    if (listNotebookRuntimeTemplatesRetry != null) {
      RetrySettings listNotebookRuntimeTemplatesRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.listNotebookRuntimeTemplatesSettings().getRetrySettings(),
              listNotebookRuntimeTemplatesRetry);
      clientSettingsBuilder
          .listNotebookRuntimeTemplatesSettings()
          .setRetrySettings(listNotebookRuntimeTemplatesRetrySettings);
      if (LOGGER.isTraceEnabled()) {
    ...
    if (getNotebookRuntimeRetry != null) {
      RetrySettings getNotebookRuntimeRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.getNotebookRuntimeSettings().getRetrySettings(),
              getNotebookRuntimeRetry);
      clientSettingsBuilder
          .getNotebookRuntimeSettings()
          .setRetrySettings(getNotebookRuntimeRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for getNotebookRuntime from properties.");
      }
    }
    Retry listNotebookRuntimesRetry = clientProperties.getListNotebookRuntimesRetry();
    if (listNotebookRuntimesRetry != null) {
      RetrySettings listNotebookRuntimesRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.listNotebookRuntimesSettings().getRetrySettings(),
              listNotebookRuntimesRetry);
      clientSettingsBuilder
          .listNotebookRuntimesSettings()
          .setRetrySettings(listNotebookRuntimesRetrySettings);
      if (LOGGER.isTraceEnabled()) {
