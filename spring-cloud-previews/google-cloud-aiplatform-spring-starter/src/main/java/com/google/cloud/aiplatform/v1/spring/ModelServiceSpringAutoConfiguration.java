...
public class ModelServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a ModelServiceSettings bean configured to use the default credentials provider
   * (obtained with modelServiceCredentials()) and its default transport channel provider
