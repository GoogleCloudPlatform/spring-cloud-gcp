...
@ConfigurationProperties("com.google.cloud.aiplatform.v1.spring.auto.job-service")
public class JobServiceSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for deleteCustomJob. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteCustomJobRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for deleteDataLabelingJob. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteDataLabelingJobRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for deleteHyperparameterTuningJob. If defined,
   * this takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteHyperparameterTuningJobRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for deleteBatchPredictionJob. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteBatchPredictionJobRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for updateModelDeploymentMonitoringJob. If
   * defined, this takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry updateModelDeploymentMonitoringJobRetry;
  /**
   * Allow override of retry settings at method-level for deleteModelDeploymentMonitoringJob. If
   * defined, this takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteModelDeploymentMonitoringJobRetry;
  /**
  ...
  public Retry getDeleteCustomJobRetry() {
    return this.deleteCustomJobRetry;
  }

  public void setDeleteCustomJobRetry(Retry deleteCustomJobRetry) {
    this.deleteCustomJobRetry = deleteCustomJobRetry;
  }
  ...
  public Retry getDeleteDataLabelingJobRetry() {
    return this.deleteDataLabelingJobRetry;
  }

  public void setDeleteDataLabelingJobRetry(Retry deleteDataLabelingJobRetry) {
    this.deleteDataLabelingJobRetry = deleteDataLabelingJobRetry;
  }
  ...
  public Retry getDeleteHyperparameterTuningJobRetry() {
    return this.deleteHyperparameterTuningJobRetry;
  }

  public void setDeleteHyperparameterTuningJobRetry(Retry deleteHyperparameterTuningJobRetry) {
    this.deleteHyperparameterTuningJobRetry = deleteHyperparameterTuningJobRetry;
  }
  ...
  public Retry getDeleteBatchPredictionJobRetry() {
    return this.deleteBatchPredictionJobRetry;
  }

  public void setDeleteBatchPredictionJobRetry(Retry deleteBatchPredictionJobRetry) {
    this.deleteBatchPredictionJobRetry = deleteBatchPredictionJobRetry;
  }
  ...
  public Retry getUpdateModelDeploymentMonitoringJobRetry() {
    return this.updateModelDeploymentMonitoringJobRetry;
  }

  public void setUpdateModelDeploymentMonitoringJobRetry(
      Retry updateModelDeploymentMonitoringJobRetry) {
    this.updateModelDeploymentMonitoringJobRetry = updateModelDeploymentMonitoringJobRetry;
  }

  public Retry getDeleteModelDeploymentMonitoringJobRetry() {
    return this.deleteModelDeploymentMonitoringJobRetry;
  }

  public void setDeleteModelDeploymentMonitoringJobRetry(
      Retry deleteModelDeploymentMonitoringJobRetry) {
    this.deleteModelDeploymentMonitoringJobRetry = deleteModelDeploymentMonitoringJobRetry;
  }
