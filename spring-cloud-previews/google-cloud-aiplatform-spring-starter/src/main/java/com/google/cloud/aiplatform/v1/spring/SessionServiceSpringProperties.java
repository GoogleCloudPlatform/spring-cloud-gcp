...
/** Provides default property values for SessionService client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.aiplatform.v1.session-service")
public class SessionServiceSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for listEvents. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry listEventsRetry;
  /**
   * Allow override of retry settings at method-level for appendEvent. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry appendEventRetry;
  /**
  ...
  public Retry getListEventsRetry() {
    return this.listEventsRetry;
  }

  public void setListEventsRetry(Retry listEventsRetry) {
    this.listEventsRetry = listEventsRetry;
  }

  public Retry getAppendEventRetry() {
    return this.appendEventRetry;
  }

  public void setAppendEventRetry(Retry appendEventRetry) {
    this.appendEventRetry = appendEventRetry;
  }
