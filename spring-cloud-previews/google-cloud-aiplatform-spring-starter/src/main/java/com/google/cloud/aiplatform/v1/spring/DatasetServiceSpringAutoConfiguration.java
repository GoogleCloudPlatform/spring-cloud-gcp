...
@ConditionalOnProperty(
    value = "com.google.cloud.aiplatform.v1.spring.auto.dataset-service.enabled",
    matchIfMissing = true)
...
public class DatasetServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a DatasetServiceClient bean configured to use the default credentials provider
  ...
  public DatasetServiceSettings datasetServiceSettings(
      ...
      throws IOException {
    DatasetServiceSettings.Builder clientSettingsBuilder =
