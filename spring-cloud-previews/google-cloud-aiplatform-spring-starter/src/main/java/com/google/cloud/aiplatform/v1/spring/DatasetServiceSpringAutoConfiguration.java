...
public class DatasetServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a DatasetServiceSettings bean configured to use a DefaultCredentialsProvider and the
   * client library's default transport channel provider
   * (defaultDatasetServiceTransportChannelProvider()). It also configures the quota project ID and
