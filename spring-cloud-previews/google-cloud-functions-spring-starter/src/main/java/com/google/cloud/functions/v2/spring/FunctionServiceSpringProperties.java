...
@ConfigurationProperties("com.google.cloud.functions.v2.spring.auto.function-service")
public class FunctionServiceSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for createFunction. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createFunctionRetry;
  /**
   * Allow override of retry settings at method-level for updateFunction. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry updateFunctionRetry;
  /**
   * Allow override of retry settings at method-level for deleteFunction. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteFunctionRetry;
  /**
  ...
  public Retry getCreateFunctionRetry() {
    return this.createFunctionRetry;
  }

  public void setCreateFunctionRetry(Retry createFunctionRetry) {
    this.createFunctionRetry = createFunctionRetry;
  }

  public Retry getUpdateFunctionRetry() {
    return this.updateFunctionRetry;
  }

  public void setUpdateFunctionRetry(Retry updateFunctionRetry) {
    this.updateFunctionRetry = updateFunctionRetry;
  }

  public Retry getDeleteFunctionRetry() {
    return this.deleteFunctionRetry;
  }

  public void setDeleteFunctionRetry(Retry deleteFunctionRetry) {
    this.deleteFunctionRetry = deleteFunctionRetry;
  }
