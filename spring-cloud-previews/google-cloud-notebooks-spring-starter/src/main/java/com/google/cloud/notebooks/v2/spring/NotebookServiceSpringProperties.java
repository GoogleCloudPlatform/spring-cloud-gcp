...
@ConfigurationProperties("com.google.cloud.notebooks.v2.notebook-service")
public class NotebookServiceSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for checkInstanceUpgradability. If defined,
   * this takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry checkInstanceUpgradabilityRetry;
  /**
  ...
  public Retry getCheckInstanceUpgradabilityRetry() {
    return this.checkInstanceUpgradabilityRetry;
  }

  public void setCheckInstanceUpgradabilityRetry(Retry checkInstanceUpgradabilityRetry) {
    this.checkInstanceUpgradabilityRetry = checkInstanceUpgradabilityRetry;
  }
