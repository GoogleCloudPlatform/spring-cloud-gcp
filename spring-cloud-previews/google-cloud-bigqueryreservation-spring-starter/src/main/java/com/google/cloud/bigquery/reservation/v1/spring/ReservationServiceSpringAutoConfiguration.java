...
@ConditionalOnProperty(
    value = "com.google.cloud.bigquery.reservation.v1.spring.auto.reservation-service.enabled",
    matchIfMissing = true)
...
public class ReservationServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a ReservationServiceClient bean configured to use the default credentials provider
   * (obtained with reservationServiceCredentials()) and its default transport channel provider
