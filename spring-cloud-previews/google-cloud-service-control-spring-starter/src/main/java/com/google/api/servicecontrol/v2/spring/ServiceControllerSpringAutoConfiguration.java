...
@ConditionalOnProperty(
    value = "com.google.api.servicecontrol.v2.service-controller.enabled",
    matchIfMissing = true)
@EnableConfigurationProperties(ServiceControllerSpringProperties.class)
public class ServiceControllerSpringAutoConfiguration {
  ...
  protected ServiceControllerSpringAutoConfiguration(
      ServiceControllerSpringProperties clientProperties, CredentialsProvider credentialsProvider)
      throws IOException {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultServiceControllerTransportChannelProvider")
  public TransportChannelProvider defaultServiceControllerTransportChannelProvider() {
    if (this.clientProperties.getUseRest()) {
      return ServiceControllerSettings.defaultHttpJsonTransportProviderBuilder().build();
    }
    return ServiceControllerSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a ServiceControllerSettings bean configured to use the default credentials provider
