...
@ConditionalOnProperty(
    value = "com.google.cloud.tasks.v2.spring.auto.cloud-tasks.enabled",
    matchIfMissing = true)
...
public class CloudTasksSpringAutoConfiguration {
  ...
  /**
   * Provides a CloudTasksClient bean configured to use the default credentials provider (obtained
