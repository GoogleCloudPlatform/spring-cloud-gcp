...
public class GSuiteAddOnsSpringAutoConfiguration {
  ...
  /**
   * Provides a GSuiteAddOnsSettings bean configured to use the default credentials provider
   * (obtained with gSuiteAddOnsCredentials()) and its default transport channel provider
