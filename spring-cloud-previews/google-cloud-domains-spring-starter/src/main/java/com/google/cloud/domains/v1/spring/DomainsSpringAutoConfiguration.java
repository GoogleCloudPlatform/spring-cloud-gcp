...
public class DomainsSpringAutoConfiguration {
  ...
  /**
   * Provides a DomainsSettings bean configured to use the default credentials provider (obtained
   * with domainsCredentials()) and its default transport channel provider
