...
public class RecommenderSpringAutoConfiguration {
  ...
  /**
   * Provides a RecommenderSettings bean configured to use the default credentials provider
   * (obtained with recommenderCredentials()) and its default transport channel provider
