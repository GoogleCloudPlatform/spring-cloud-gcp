...
public class BatchControllerSpringAutoConfiguration {
  ...
  public BatchControllerSettings batchControllerSettings(
    ...
    if (serviceRetry != null) {
      RetrySettings createBatchRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createBatchSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder.createBatchSettings().setRetrySettings(createBatchRetrySettings);
    ...
    Retry createBatchRetry = clientProperties.getCreateBatchRetry();
    if (createBatchRetry != null) {
      RetrySettings createBatchRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createBatchSettings().getRetrySettings(), createBatchRetry);
      clientSettingsBuilder.createBatchSettings().setRetrySettings(createBatchRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for createBatch from properties.");
      }
    }
