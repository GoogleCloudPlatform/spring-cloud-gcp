...
public class ClusterControllerSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for stopCluster. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry stopClusterRetry;
  /**
   * Allow override of retry settings at method-level for startCluster. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry startClusterRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for diagnoseCluster. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry diagnoseClusterRetry;
  ...
  public Retry getStopClusterRetry() {
    return this.stopClusterRetry;
  }

  public void setStopClusterRetry(Retry stopClusterRetry) {
    this.stopClusterRetry = stopClusterRetry;
  }

  public Retry getStartClusterRetry() {
    return this.startClusterRetry;
  }

  public void setStartClusterRetry(Retry startClusterRetry) {
    this.startClusterRetry = startClusterRetry;
  }
  ...
  public Retry getDiagnoseClusterRetry() {
    return this.diagnoseClusterRetry;
  }

  public void setDiagnoseClusterRetry(Retry diagnoseClusterRetry) {
    this.diagnoseClusterRetry = diagnoseClusterRetry;
  }
}
