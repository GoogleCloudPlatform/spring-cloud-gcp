...
public class WorkflowTemplateServiceSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for instantiateWorkflowTemplate. If defined,
   * this takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry instantiateWorkflowTemplateRetry;
  /**
   * Allow override of retry settings at method-level for instantiateInlineWorkflowTemplate. If
   * defined, this takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry instantiateInlineWorkflowTemplateRetry;
  /**
  ...
  public Retry getInstantiateWorkflowTemplateRetry() {
    return this.instantiateWorkflowTemplateRetry;
  }

  public void setInstantiateWorkflowTemplateRetry(Retry instantiateWorkflowTemplateRetry) {
    this.instantiateWorkflowTemplateRetry = instantiateWorkflowTemplateRetry;
  }

  public Retry getInstantiateInlineWorkflowTemplateRetry() {
    return this.instantiateInlineWorkflowTemplateRetry;
  }

  public void setInstantiateInlineWorkflowTemplateRetry(
      Retry instantiateInlineWorkflowTemplateRetry) {
    this.instantiateInlineWorkflowTemplateRetry = instantiateInlineWorkflowTemplateRetry;
  }
