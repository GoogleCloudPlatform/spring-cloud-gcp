...
public class JobControllerSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for submitJobAsOperation. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry submitJobAsOperationRetry;
  /**
  ...
  public Retry getSubmitJobAsOperationRetry() {
    return this.submitJobAsOperationRetry;
  }

  public void setSubmitJobAsOperationRetry(Retry submitJobAsOperationRetry) {
    this.submitJobAsOperationRetry = submitJobAsOperationRetry;
  }
