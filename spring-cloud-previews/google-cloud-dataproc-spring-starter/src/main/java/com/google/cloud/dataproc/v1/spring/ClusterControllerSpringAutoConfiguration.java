...
@ConditionalOnProperty(
    value = "com.google.cloud.dataproc.v1.cluster-controller.enabled",
    matchIfMissing = true)
...
public class ClusterControllerSpringAutoConfiguration {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultClusterControllerTransportChannelProvider")
  public TransportChannelProvider defaultClusterControllerTransportChannelProvider() {
    if (this.clientProperties.getUseRest()) {
      return ClusterControllerSettings.defaultHttpJsonTransportProviderBuilder().build();
    }
    return ClusterControllerSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a ClusterControllerSettings bean configured to use a DefaultCredentialsProvider and
   ...
   * @return a {@link ClusterControllerSettings} bean configured with {@link
  ...
  public ClusterControllerSettings clusterControllerSettings(
    ...
    if (this.clientProperties.getUseRest()) {
      clientSettingsBuilder = ClusterControllerSettings.newHttpJsonBuilder();
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Using REST (HTTP/JSON) transport.");
      }
    } else {
      clientSettingsBuilder = ClusterControllerSettings.newBuilder();
    }
   ...
   *
   * @param clusterControllerSettings settings to configure an instance of client bean.
   * @return a {@link ClusterControllerClient} bean configured with {@link
