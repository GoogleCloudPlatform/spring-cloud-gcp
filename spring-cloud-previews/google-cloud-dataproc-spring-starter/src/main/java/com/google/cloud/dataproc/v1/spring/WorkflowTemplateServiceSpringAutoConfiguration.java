...
@ConditionalOnProperty(
    value = "com.google.cloud.dataproc.v1.workflow-template-service.enabled",
    matchIfMissing = true)
...
public class WorkflowTemplateServiceSpringAutoConfiguration {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultWorkflowTemplateServiceTransportChannelProvider")
  public TransportChannelProvider defaultWorkflowTemplateServiceTransportChannelProvider() {
    if (this.clientProperties.getUseRest()) {
      return WorkflowTemplateServiceSettings.defaultHttpJsonTransportProviderBuilder().build();
    }
    return WorkflowTemplateServiceSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a WorkflowTemplateServiceSettings bean configured to use a DefaultCredentialsProvider
   * and the client library's default transport channel provider
   * (defaultWorkflowTemplateServiceTransportChannelProvider()). It also configures the quota
