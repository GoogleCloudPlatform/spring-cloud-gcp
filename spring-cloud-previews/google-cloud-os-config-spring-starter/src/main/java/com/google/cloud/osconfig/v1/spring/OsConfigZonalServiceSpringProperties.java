...
public class OsConfigZonalServiceSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for createOSPolicyAssignment. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createOSPolicyAssignmentRetry;
  /**
   * Allow override of retry settings at method-level for updateOSPolicyAssignment. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry updateOSPolicyAssignmentRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for deleteOSPolicyAssignment. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteOSPolicyAssignmentRetry;
  /**
  ...
  public Retry getCreateOSPolicyAssignmentRetry() {
    return this.createOSPolicyAssignmentRetry;
  }

  public void setCreateOSPolicyAssignmentRetry(Retry createOSPolicyAssignmentRetry) {
    this.createOSPolicyAssignmentRetry = createOSPolicyAssignmentRetry;
  }

  public Retry getUpdateOSPolicyAssignmentRetry() {
    return this.updateOSPolicyAssignmentRetry;
  }

  public void setUpdateOSPolicyAssignmentRetry(Retry updateOSPolicyAssignmentRetry) {
    this.updateOSPolicyAssignmentRetry = updateOSPolicyAssignmentRetry;
  }
  ...
  public Retry getDeleteOSPolicyAssignmentRetry() {
    return this.deleteOSPolicyAssignmentRetry;
  }

  public void setDeleteOSPolicyAssignmentRetry(Retry deleteOSPolicyAssignmentRetry) {
    this.deleteOSPolicyAssignmentRetry = deleteOSPolicyAssignmentRetry;
  }
