...
public class FleetRoutingSpringAutoConfiguration {
  ...
  /**
   * Provides a FleetRoutingSettings bean configured to use a DefaultCredentialsProvider and the
   * client library's default transport channel provider
   * (defaultFleetRoutingTransportChannelProvider()). It also configures the quota project ID and
