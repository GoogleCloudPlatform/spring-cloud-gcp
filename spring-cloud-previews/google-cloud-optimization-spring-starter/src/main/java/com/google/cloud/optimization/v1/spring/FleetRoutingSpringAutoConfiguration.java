...
@ConditionalOnProperty(
    value = "com.google.cloud.optimization.v1.fleet-routing.enabled",
    matchIfMissing = true)
...
public class FleetRoutingSpringAutoConfiguration {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultFleetRoutingTransportChannelProvider")
  public TransportChannelProvider defaultFleetRoutingTransportChannelProvider() {
    if (this.clientProperties.getUseRest()) {
      return FleetRoutingSettings.defaultHttpJsonTransportProviderBuilder().build();
    }
    return FleetRoutingSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a FleetRoutingSettings bean configured to use the default credentials provider
   * (obtained with fleetRoutingCredentials()) and its default transport channel provider
