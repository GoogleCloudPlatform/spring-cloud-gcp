...
@ConfigurationProperties("com.google.cloud.optimization.v1.spring.auto.fleet-routing")
public class FleetRoutingSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for batchOptimizeTours. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry batchOptimizeToursRetry;
  ...
  public Retry getBatchOptimizeToursRetry() {
    return this.batchOptimizeToursRetry;
  }

  public void setBatchOptimizeToursRetry(Retry batchOptimizeToursRetry) {
    this.batchOptimizeToursRetry = batchOptimizeToursRetry;
  }
}
