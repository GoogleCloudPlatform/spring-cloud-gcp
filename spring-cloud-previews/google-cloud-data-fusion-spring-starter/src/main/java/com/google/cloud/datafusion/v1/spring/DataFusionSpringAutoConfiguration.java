...
public class DataFusionSpringAutoConfiguration {
  ...
  public DataFusionSettings dataFusionSettings(
    ...
    if (serviceRetry != null) {
      ...
      RetrySettings restartInstanceRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.restartInstanceSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .restartInstanceSettings()
          .setRetrySettings(restartInstanceRetrySettings);
    ...
    Retry restartInstanceRetry = clientProperties.getRestartInstanceRetry();
    if (restartInstanceRetry != null) {
      RetrySettings restartInstanceRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.restartInstanceSettings().getRetrySettings(),
              restartInstanceRetry);
      clientSettingsBuilder
          .restartInstanceSettings()
          .setRetrySettings(restartInstanceRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for restartInstance from properties.");
      }
    }
