...
@ConfigurationProperties("com.google.cloud.talent.v4.spring.auto.job-service")
public class JobServiceSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for batchCreateJobs. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry batchCreateJobsRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for batchUpdateJobs. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry batchUpdateJobsRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for batchDeleteJobs. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry batchDeleteJobsRetry;
  /**
  ...
  public Retry getBatchCreateJobsRetry() {
    return this.batchCreateJobsRetry;
  }

  public void setBatchCreateJobsRetry(Retry batchCreateJobsRetry) {
    this.batchCreateJobsRetry = batchCreateJobsRetry;
  }
  ...
  public Retry getBatchUpdateJobsRetry() {
    return this.batchUpdateJobsRetry;
  }

  public void setBatchUpdateJobsRetry(Retry batchUpdateJobsRetry) {
    this.batchUpdateJobsRetry = batchUpdateJobsRetry;
  }
  ...
  public Retry getBatchDeleteJobsRetry() {
    return this.batchDeleteJobsRetry;
  }

  public void setBatchDeleteJobsRetry(Retry batchDeleteJobsRetry) {
    this.batchDeleteJobsRetry = batchDeleteJobsRetry;
  }
