...
@ConditionalOnProperty(
    value = "com.google.cloud.talent.v4.spring.auto.company-service.enabled",
    matchIfMissing = true)
...
public class CompanyServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a CompanyServiceClient bean configured to use the default credentials provider
   * (obtained with companyServiceCredentials()) and its default transport channel provider
   * (defaultCompanyServiceTransportChannelProvider()). It also configures the quota project ID if
