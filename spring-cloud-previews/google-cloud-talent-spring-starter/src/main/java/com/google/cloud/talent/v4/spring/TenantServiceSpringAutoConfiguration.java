...
public class TenantServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a TenantServiceSettings bean configured to use a DefaultCredentialsProvider and the
   * client library's default transport channel provider
   * (defaultTenantServiceTransportChannelProvider()). It also configures the quota project ID and
