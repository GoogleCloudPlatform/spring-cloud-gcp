...
/**
 * Auto-configuration for {@link TenantServiceClient}.
 *
...
@ConditionalOnProperty(
    value = "com.google.cloud.talent.v4.tenant-service.enabled",
    matchIfMissing = true)
...
public class TenantServiceSpringAutoConfiguration {
  ...
  protected TenantServiceSpringAutoConfiguration(
      TenantServiceSpringProperties clientProperties, CredentialsProvider credentialsProvider)
      throws IOException {
  ...
  public TransportChannelProvider defaultTenantServiceTransportChannelProvider() {
    if (this.clientProperties.getUseRest()) {
      return TenantServiceSettings.defaultHttpJsonTransportProviderBuilder().build();
    }
    return TenantServiceSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a TenantServiceSettings bean configured to use the default credentials provider
   * (obtained with tenantServiceCredentials()) and its default transport channel provider
   * (defaultTenantServiceTransportChannelProvider()). It also configures the quota project ID if
