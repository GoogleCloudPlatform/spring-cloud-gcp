...
@ConditionalOnProperty(
    value = "com.google.cloud.talent.v4.spring.auto.tenant-service.enabled",
    matchIfMissing = true)
...
public class TenantServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a TenantServiceClient bean configured to use the default credentials provider
