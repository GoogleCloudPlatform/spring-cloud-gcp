...
public class ParticipantsSpringAutoConfiguration {
  ...
  /**
   * Provides a ParticipantsSettings bean configured to use the default credentials provider
   * (obtained with participantsCredentials()) and its default transport channel provider
