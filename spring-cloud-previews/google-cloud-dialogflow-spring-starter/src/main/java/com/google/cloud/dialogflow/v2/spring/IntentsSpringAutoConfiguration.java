...
public class IntentsSpringAutoConfiguration {
  ...
  /**
   * Provides a IntentsSettings bean configured to use the default credentials provider (obtained
   * with intentsCredentials()) and its default transport channel provider
