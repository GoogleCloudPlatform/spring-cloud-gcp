...
public class AgentsSpringAutoConfiguration {
  ...
  /**
   * Provides a AgentsSettings bean configured to use the default credentials provider (obtained
   * with agentsCredentials()) and its default transport channel provider
