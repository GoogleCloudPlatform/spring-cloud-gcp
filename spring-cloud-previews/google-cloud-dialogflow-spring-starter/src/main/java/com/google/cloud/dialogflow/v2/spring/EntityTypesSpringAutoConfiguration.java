...
public class EntityTypesSpringAutoConfiguration {
  ...
  /**
   * Provides a EntityTypesSettings bean configured to use the default credentials provider
   * (obtained with entityTypesCredentials()) and its default transport channel provider
