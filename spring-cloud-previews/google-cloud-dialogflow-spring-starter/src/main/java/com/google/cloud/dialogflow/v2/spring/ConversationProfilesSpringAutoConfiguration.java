...
public class ConversationProfilesSpringAutoConfiguration {
  ...
  public ConversationProfilesSettings conversationProfilesSettings(
    ...
    if (serviceRetry != null) {
      ...
      RetrySettings setSuggestionFeatureConfigRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.setSuggestionFeatureConfigSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .setSuggestionFeatureConfigSettings()
          .setRetrySettings(setSuggestionFeatureConfigRetrySettings);

      RetrySettings clearSuggestionFeatureConfigRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.clearSuggestionFeatureConfigSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .clearSuggestionFeatureConfigSettings()
          .setRetrySettings(clearSuggestionFeatureConfigRetrySettings);
    ...
    Retry setSuggestionFeatureConfigRetry = clientProperties.getSetSuggestionFeatureConfigRetry();
    if (setSuggestionFeatureConfigRetry != null) {
      RetrySettings setSuggestionFeatureConfigRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.setSuggestionFeatureConfigSettings().getRetrySettings(),
              setSuggestionFeatureConfigRetry);
      clientSettingsBuilder
          .setSuggestionFeatureConfigSettings()
          .setRetrySettings(setSuggestionFeatureConfigRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for setSuggestionFeatureConfig from properties.");
      }
    }
    Retry clearSuggestionFeatureConfigRetry =
        clientProperties.getClearSuggestionFeatureConfigRetry();
    if (clearSuggestionFeatureConfigRetry != null) {
      RetrySettings clearSuggestionFeatureConfigRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.clearSuggestionFeatureConfigSettings().getRetrySettings(),
              clearSuggestionFeatureConfigRetry);
      clientSettingsBuilder
          .clearSuggestionFeatureConfigSettings()
          .setRetrySettings(clearSuggestionFeatureConfigRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for clearSuggestionFeatureConfig from properties.");
      }
    }
