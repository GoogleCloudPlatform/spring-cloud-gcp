...
@ConfigurationProperties("com.google.cloud.dialogflow.v2.conversations")
public class ConversationsSpringProperties implements CredentialsSupplier {
  ...
  public Retry getCompleteConversationRetry() {
    return this.completeConversationRetry;
  }

  public void setCompleteConversationRetry(Retry completeConversationRetry) {
  ...
  public Retry getGenerateStatelessSuggestionRetry() {
    return this.generateStatelessSuggestionRetry;
  }

  public void setGenerateStatelessSuggestionRetry(Retry generateStatelessSuggestionRetry) {
