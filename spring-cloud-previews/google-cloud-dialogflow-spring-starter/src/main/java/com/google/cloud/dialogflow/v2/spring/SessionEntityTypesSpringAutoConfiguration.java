...
@ConditionalOnProperty(
    value = "com.google.cloud.dialogflow.v2.session-entity-types.enabled",
    matchIfMissing = true)
...
public class SessionEntityTypesSpringAutoConfiguration {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultSessionEntityTypesTransportChannelProvider")
  public TransportChannelProvider defaultSessionEntityTypesTransportChannelProvider() {
    if (this.clientProperties.getUseRest()) {
      return SessionEntityTypesSettings.defaultHttpJsonTransportProviderBuilder().build();
    }
    return SessionEntityTypesSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a SessionEntityTypesSettings bean configured to use a DefaultCredentialsProvider and
   ...
   * @return a {@link SessionEntityTypesSettings} bean configured with {@link
  ...
  public SessionEntityTypesSettings sessionEntityTypesSettings(
    ...
    if (this.clientProperties.getUseRest()) {
      clientSettingsBuilder = SessionEntityTypesSettings.newHttpJsonBuilder();
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Using REST (HTTP/JSON) transport.");
      }
    } else {
      clientSettingsBuilder = SessionEntityTypesSettings.newBuilder();
    }
   ...
   *
   * @param sessionEntityTypesSettings settings to configure an instance of client bean.
   * @return a {@link SessionEntityTypesClient} bean configured with {@link
