...
@ConditionalOnProperty(
    value = "com.google.cloud.dialogflow.v2.environments.enabled",
    matchIfMissing = true)
...
public class EnvironmentsSpringAutoConfiguration {
  ...
  /**
   * Provides a EnvironmentsSettings bean configured to use the default credentials provider
   * (obtained with environmentsCredentials()) and its default transport channel provider
  ...
  public EnvironmentsSettings environmentsSettings(
    ...
    if (serviceRetry != null) {
      ...
      RetrySettings getEnvironmentHistoryRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.getEnvironmentHistorySettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
    ...
    Retry getEnvironmentHistoryRetry = clientProperties.getGetEnvironmentHistoryRetry();
    if (getEnvironmentHistoryRetry != null) {
      RetrySettings getEnvironmentHistoryRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.getEnvironmentHistorySettings().getRetrySettings(),
              getEnvironmentHistoryRetry);
      clientSettingsBuilder
          .getEnvironmentHistorySettings()
          .setRetrySettings(getEnvironmentHistoryRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for getEnvironmentHistory from properties.");
      }
    }
