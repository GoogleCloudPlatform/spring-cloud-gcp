...
public class ConversationModelsSpringAutoConfiguration {
  ...
  public ConversationModelsSettings conversationModelsSettings(
    ...
    if (serviceRetry != null) {
      RetrySettings createConversationModelRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createConversationModelSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .createConversationModelSettings()
          .setRetrySettings(createConversationModelRetrySettings);
      ...
      RetrySettings deleteConversationModelRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteConversationModelSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .deleteConversationModelSettings()
          .setRetrySettings(deleteConversationModelRetrySettings);

      RetrySettings deployConversationModelRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deployConversationModelSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .deployConversationModelSettings()
          .setRetrySettings(deployConversationModelRetrySettings);

      RetrySettings undeployConversationModelRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.undeployConversationModelSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .undeployConversationModelSettings()
          .setRetrySettings(undeployConversationModelRetrySettings);
      ...
      RetrySettings createConversationModelEvaluationRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createConversationModelEvaluationSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .createConversationModelEvaluationSettings()
          .setRetrySettings(createConversationModelEvaluationRetrySettings);
    ...
    Retry createConversationModelRetry = clientProperties.getCreateConversationModelRetry();
    if (createConversationModelRetry != null) {
      RetrySettings createConversationModelRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createConversationModelSettings().getRetrySettings(),
              createConversationModelRetry);
      clientSettingsBuilder
          .createConversationModelSettings()
          .setRetrySettings(createConversationModelRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for createConversationModel from properties.");
      }
    }
    ...
    Retry deleteConversationModelRetry = clientProperties.getDeleteConversationModelRetry();
    if (deleteConversationModelRetry != null) {
      RetrySettings deleteConversationModelRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteConversationModelSettings().getRetrySettings(),
              deleteConversationModelRetry);
      clientSettingsBuilder
          .deleteConversationModelSettings()
          .setRetrySettings(deleteConversationModelRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deleteConversationModel from properties.");
      }
    }
    Retry deployConversationModelRetry = clientProperties.getDeployConversationModelRetry();
    if (deployConversationModelRetry != null) {
      RetrySettings deployConversationModelRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deployConversationModelSettings().getRetrySettings(),
              deployConversationModelRetry);
      clientSettingsBuilder
          .deployConversationModelSettings()
          .setRetrySettings(deployConversationModelRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deployConversationModel from properties.");
      }
    }
    Retry undeployConversationModelRetry = clientProperties.getUndeployConversationModelRetry();
    if (undeployConversationModelRetry != null) {
      RetrySettings undeployConversationModelRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.undeployConversationModelSettings().getRetrySettings(),
              undeployConversationModelRetry);
      clientSettingsBuilder
          .undeployConversationModelSettings()
          .setRetrySettings(undeployConversationModelRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for undeployConversationModel from properties.");
      }
    }
    ...
    Retry createConversationModelEvaluationRetry =
        clientProperties.getCreateConversationModelEvaluationRetry();
    if (createConversationModelEvaluationRetry != null) {
      RetrySettings createConversationModelEvaluationRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createConversationModelEvaluationSettings().getRetrySettings(),
              createConversationModelEvaluationRetry);
      clientSettingsBuilder
          .createConversationModelEvaluationSettings()
          .setRetrySettings(createConversationModelEvaluationRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for createConversationModelEvaluation from properties.");
      }
    }
