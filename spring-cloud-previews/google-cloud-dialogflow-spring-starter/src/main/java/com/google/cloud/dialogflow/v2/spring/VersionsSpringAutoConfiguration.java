...
@ConditionalOnProperty(
    value = "com.google.cloud.dialogflow.v2.versions.enabled",
    matchIfMissing = true)
@EnableConfigurationProperties(VersionsSpringProperties.class)
public class VersionsSpringAutoConfiguration {
  ...
  protected VersionsSpringAutoConfiguration(
      VersionsSpringProperties clientProperties, CredentialsProvider credentialsProvider)
      throws IOException {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultVersionsTransportChannelProvider")
  public TransportChannelProvider defaultVersionsTransportChannelProvider() {
    if (this.clientProperties.getUseRest()) {
      return VersionsSettings.defaultHttpJsonTransportProviderBuilder().build();
    }
    return VersionsSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a VersionsSettings bean configured to use a DefaultCredentialsProvider and the client
   * library's default transport channel provider (defaultVersionsTransportChannelProvider()). It
