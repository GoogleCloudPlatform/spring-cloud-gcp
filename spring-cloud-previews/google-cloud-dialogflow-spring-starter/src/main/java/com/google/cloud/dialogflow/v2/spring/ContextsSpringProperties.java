...
public class ContextsSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for deleteAllContexts. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteAllContextsRetry;
  /**
  ...
  public Retry getDeleteAllContextsRetry() {
    return this.deleteAllContextsRetry;
  }

  public void setDeleteAllContextsRetry(Retry deleteAllContextsRetry) {
    this.deleteAllContextsRetry = deleteAllContextsRetry;
  }
