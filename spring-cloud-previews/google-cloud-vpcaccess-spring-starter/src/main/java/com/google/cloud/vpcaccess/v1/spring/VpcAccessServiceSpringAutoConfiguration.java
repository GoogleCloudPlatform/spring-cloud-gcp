...
@ConditionalOnProperty(
    value = "com.google.cloud.vpcaccess.v1.vpc-access-service.enabled",
    matchIfMissing = true)
...
public class VpcAccessServiceSpringAutoConfiguration {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultVpcAccessServiceTransportChannelProvider")
  public TransportChannelProvider defaultVpcAccessServiceTransportChannelProvider() {
    if (this.clientProperties.getUseRest()) {
      return VpcAccessServiceSettings.defaultHttpJsonTransportProviderBuilder().build();
    }
    return VpcAccessServiceSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a VpcAccessServiceSettings bean configured to use a DefaultCredentialsProvider and the
   * client library's default transport channel provider
   * (defaultVpcAccessServiceTransportChannelProvider()). It also configures the quota project ID
