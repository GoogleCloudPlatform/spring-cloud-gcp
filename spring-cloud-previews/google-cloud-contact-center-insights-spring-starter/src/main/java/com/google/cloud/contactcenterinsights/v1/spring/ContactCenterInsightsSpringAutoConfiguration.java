...
public class ContactCenterInsightsSpringAutoConfiguration {
  ...
  /**
   * Provides a ContactCenterInsightsSettings bean configured to use the default credentials
   * provider (obtained with contactCenterInsightsCredentials()) and its default transport channel
   * provider (defaultContactCenterInsightsTransportChannelProvider()). It also configures the quota
