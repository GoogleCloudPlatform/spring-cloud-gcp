...
public class ContactCenterInsightsSpringAutoConfiguration {
  ...
  public ContactCenterInsightsSettings contactCenterInsightsSettings(
    ...
    if (serviceRetry != null) {
      ...
      RetrySettings createAnalysisRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createAnalysisSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder.createAnalysisSettings().setRetrySettings(createAnalysisRetrySettings);
      ...
      RetrySettings bulkAnalyzeConversationsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.bulkAnalyzeConversationsSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .bulkAnalyzeConversationsSettings()
          .setRetrySettings(bulkAnalyzeConversationsRetrySettings);

      RetrySettings ingestConversationsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.ingestConversationsSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .ingestConversationsSettings()
          .setRetrySettings(ingestConversationsRetrySettings);

      RetrySettings exportInsightsDataRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.exportInsightsDataSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .exportInsightsDataSettings()
          .setRetrySettings(exportInsightsDataRetrySettings);

      RetrySettings createIssueModelRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createIssueModelSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .createIssueModelSettings()
          .setRetrySettings(createIssueModelRetrySettings);
      ...
      RetrySettings deleteIssueModelRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteIssueModelSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .deleteIssueModelSettings()
          .setRetrySettings(deleteIssueModelRetrySettings);

      RetrySettings deployIssueModelRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deployIssueModelSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .deployIssueModelSettings()
          .setRetrySettings(deployIssueModelRetrySettings);

      RetrySettings undeployIssueModelRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.undeployIssueModelSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .undeployIssueModelSettings()
          .setRetrySettings(undeployIssueModelRetrySettings);
    ...
    Retry createAnalysisRetry = clientProperties.getCreateAnalysisRetry();
    if (createAnalysisRetry != null) {
      RetrySettings createAnalysisRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createAnalysisSettings().getRetrySettings(),
              createAnalysisRetry);
      clientSettingsBuilder.createAnalysisSettings().setRetrySettings(createAnalysisRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for createAnalysis from properties.");
      }
    }
    ...
    Retry bulkAnalyzeConversationsRetry = clientProperties.getBulkAnalyzeConversationsRetry();
    if (bulkAnalyzeConversationsRetry != null) {
      RetrySettings bulkAnalyzeConversationsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.bulkAnalyzeConversationsSettings().getRetrySettings(),
              bulkAnalyzeConversationsRetry);
      clientSettingsBuilder
          .bulkAnalyzeConversationsSettings()
          .setRetrySettings(bulkAnalyzeConversationsRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for bulkAnalyzeConversations from properties.");
      }
    }
    Retry ingestConversationsRetry = clientProperties.getIngestConversationsRetry();
    if (ingestConversationsRetry != null) {
      RetrySettings ingestConversationsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.ingestConversationsSettings().getRetrySettings(),
              ingestConversationsRetry);
      clientSettingsBuilder
          .ingestConversationsSettings()
          .setRetrySettings(ingestConversationsRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for ingestConversations from properties.");
      }
    }
    Retry exportInsightsDataRetry = clientProperties.getExportInsightsDataRetry();
    if (exportInsightsDataRetry != null) {
      RetrySettings exportInsightsDataRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.exportInsightsDataSettings().getRetrySettings(),
              exportInsightsDataRetry);
      clientSettingsBuilder
          .exportInsightsDataSettings()
          .setRetrySettings(exportInsightsDataRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for exportInsightsData from properties.");
      }
    }
    Retry createIssueModelRetry = clientProperties.getCreateIssueModelRetry();
    if (createIssueModelRetry != null) {
      RetrySettings createIssueModelRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createIssueModelSettings().getRetrySettings(),
              createIssueModelRetry);
      clientSettingsBuilder
          .createIssueModelSettings()
          .setRetrySettings(createIssueModelRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for createIssueModel from properties.");
      }
    }
    ...
    Retry deleteIssueModelRetry = clientProperties.getDeleteIssueModelRetry();
    if (deleteIssueModelRetry != null) {
      RetrySettings deleteIssueModelRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteIssueModelSettings().getRetrySettings(),
              deleteIssueModelRetry);
      clientSettingsBuilder
          .deleteIssueModelSettings()
          .setRetrySettings(deleteIssueModelRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deleteIssueModel from properties.");
      }
    }
    Retry deployIssueModelRetry = clientProperties.getDeployIssueModelRetry();
    if (deployIssueModelRetry != null) {
      RetrySettings deployIssueModelRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deployIssueModelSettings().getRetrySettings(),
              deployIssueModelRetry);
      clientSettingsBuilder
          .deployIssueModelSettings()
          .setRetrySettings(deployIssueModelRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deployIssueModel from properties.");
      }
    }
    Retry undeployIssueModelRetry = clientProperties.getUndeployIssueModelRetry();
    if (undeployIssueModelRetry != null) {
      RetrySettings undeployIssueModelRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.undeployIssueModelSettings().getRetrySettings(),
              undeployIssueModelRetry);
      clientSettingsBuilder
          .undeployIssueModelSettings()
          .setRetrySettings(undeployIssueModelRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for undeployIssueModel from properties.");
      }
    }
