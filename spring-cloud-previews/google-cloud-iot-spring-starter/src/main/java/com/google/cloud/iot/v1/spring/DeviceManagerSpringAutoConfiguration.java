...
@ConditionalOnProperty(
    value = "com.google.cloud.iot.v1.spring.auto.device-manager.enabled",
    matchIfMissing = true)
...
public class DeviceManagerSpringAutoConfiguration {
  ...
  /**
   * Provides a DeviceManagerClient bean configured to use the default credentials provider
   * (obtained with deviceManagerCredentials()) and its default transport channel provider
   * (defaultDeviceManagerTransportChannelProvider()). It also configures the quota project ID if
