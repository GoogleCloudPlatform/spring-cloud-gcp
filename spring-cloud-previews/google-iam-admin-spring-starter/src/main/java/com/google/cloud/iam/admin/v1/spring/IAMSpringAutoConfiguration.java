...
@ConditionalOnProperty(
    value = "com.google.cloud.iam.admin.v1.spring.auto.i-a-m.enabled",
    matchIfMissing = true)
...
public class IAMSpringAutoConfiguration {
  ...
  /**
   * Provides a IAMClient bean configured to use the default credentials provider (obtained with
   * iAMCredentials()) and its default transport channel provider
   * (defaultIAMTransportChannelProvider()). It also configures the quota project ID if provided. It
  ...
  public IAMSettings iAMSettings(
      ...
      throws IOException {
    IAMSettings.Builder clientSettingsBuilder =
