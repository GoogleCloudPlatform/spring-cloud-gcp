...
@ConditionalOnProperty(
    value = "com.google.cloud.channel.v1.spring.auto.cloud-channel-service.enabled",
    matchIfMissing = true)
...
public class CloudChannelServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a CloudChannelServiceClient bean configured to use the default credentials provider
   * (obtained with cloudChannelServiceCredentials()) and its default transport channel provider
  ...
  public CloudChannelServiceSettings cloudChannelServiceSettings(
    ...
    if (serviceRetry != null) {
      ...
      RetrySettings provisionCloudIdentityRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.provisionCloudIdentitySettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .provisionCloudIdentitySettings()
          .setRetrySettings(provisionCloudIdentityRetrySettings);
      ...
      RetrySettings createEntitlementRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createEntitlementSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .createEntitlementSettings()
          .setRetrySettings(createEntitlementRetrySettings);

      RetrySettings changeParametersRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.changeParametersSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .changeParametersSettings()
          .setRetrySettings(changeParametersRetrySettings);

      RetrySettings changeRenewalSettingsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.changeRenewalSettingsSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .changeRenewalSettingsSettings()
          .setRetrySettings(changeRenewalSettingsRetrySettings);

      RetrySettings changeOfferRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.changeOfferSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder.changeOfferSettings().setRetrySettings(changeOfferRetrySettings);

      RetrySettings startPaidServiceRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.startPaidServiceSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .startPaidServiceSettings()
          .setRetrySettings(startPaidServiceRetrySettings);

      RetrySettings suspendEntitlementRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.suspendEntitlementSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .suspendEntitlementSettings()
          .setRetrySettings(suspendEntitlementRetrySettings);

      RetrySettings cancelEntitlementRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.cancelEntitlementSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .cancelEntitlementSettings()
          .setRetrySettings(cancelEntitlementRetrySettings);

      RetrySettings activateEntitlementRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.activateEntitlementSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .activateEntitlementSettings()
          .setRetrySettings(activateEntitlementRetrySettings);

      RetrySettings transferEntitlementsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.transferEntitlementsSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .transferEntitlementsSettings()
          .setRetrySettings(transferEntitlementsRetrySettings);

      RetrySettings transferEntitlementsToGoogleRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.transferEntitlementsToGoogleSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .transferEntitlementsToGoogleSettings()
          .setRetrySettings(transferEntitlementsToGoogleRetrySettings);
    ...
    Retry provisionCloudIdentityRetry = clientProperties.getProvisionCloudIdentityRetry();
    if (provisionCloudIdentityRetry != null) {
      RetrySettings provisionCloudIdentityRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.provisionCloudIdentitySettings().getRetrySettings(),
              provisionCloudIdentityRetry);
      clientSettingsBuilder
          .provisionCloudIdentitySettings()
          .setRetrySettings(provisionCloudIdentityRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for provisionCloudIdentity from properties.");
      }
    }
    ...
    Retry createEntitlementRetry = clientProperties.getCreateEntitlementRetry();
    if (createEntitlementRetry != null) {
      RetrySettings createEntitlementRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createEntitlementSettings().getRetrySettings(),
              createEntitlementRetry);
      clientSettingsBuilder
          .createEntitlementSettings()
          .setRetrySettings(createEntitlementRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for createEntitlement from properties.");
      }
    }
    Retry changeParametersRetry = clientProperties.getChangeParametersRetry();
    if (changeParametersRetry != null) {
      RetrySettings changeParametersRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.changeParametersSettings().getRetrySettings(),
              changeParametersRetry);
      clientSettingsBuilder
          .changeParametersSettings()
          .setRetrySettings(changeParametersRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for changeParameters from properties.");
      }
    }
    Retry changeRenewalSettingsRetry = clientProperties.getChangeRenewalSettingsRetry();
    if (changeRenewalSettingsRetry != null) {
      RetrySettings changeRenewalSettingsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.changeRenewalSettingsSettings().getRetrySettings(),
              changeRenewalSettingsRetry);
      clientSettingsBuilder
          .changeRenewalSettingsSettings()
          .setRetrySettings(changeRenewalSettingsRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for changeRenewalSettings from properties.");
      }
    }
    Retry changeOfferRetry = clientProperties.getChangeOfferRetry();
    if (changeOfferRetry != null) {
      RetrySettings changeOfferRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.changeOfferSettings().getRetrySettings(), changeOfferRetry);
      clientSettingsBuilder.changeOfferSettings().setRetrySettings(changeOfferRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for changeOffer from properties.");
      }
    }
    Retry startPaidServiceRetry = clientProperties.getStartPaidServiceRetry();
    if (startPaidServiceRetry != null) {
      RetrySettings startPaidServiceRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.startPaidServiceSettings().getRetrySettings(),
              startPaidServiceRetry);
      clientSettingsBuilder
          .startPaidServiceSettings()
          .setRetrySettings(startPaidServiceRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for startPaidService from properties.");
      }
    }
    Retry suspendEntitlementRetry = clientProperties.getSuspendEntitlementRetry();
    if (suspendEntitlementRetry != null) {
      RetrySettings suspendEntitlementRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.suspendEntitlementSettings().getRetrySettings(),
              suspendEntitlementRetry);
      clientSettingsBuilder
          .suspendEntitlementSettings()
          .setRetrySettings(suspendEntitlementRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for suspendEntitlement from properties.");
      }
    }
    Retry cancelEntitlementRetry = clientProperties.getCancelEntitlementRetry();
    if (cancelEntitlementRetry != null) {
      RetrySettings cancelEntitlementRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.cancelEntitlementSettings().getRetrySettings(),
              cancelEntitlementRetry);
      clientSettingsBuilder
          .cancelEntitlementSettings()
          .setRetrySettings(cancelEntitlementRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for cancelEntitlement from properties.");
      }
    }
    Retry activateEntitlementRetry = clientProperties.getActivateEntitlementRetry();
    if (activateEntitlementRetry != null) {
      RetrySettings activateEntitlementRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.activateEntitlementSettings().getRetrySettings(),
              activateEntitlementRetry);
      clientSettingsBuilder
          .activateEntitlementSettings()
          .setRetrySettings(activateEntitlementRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for activateEntitlement from properties.");
      }
    }
    Retry transferEntitlementsRetry = clientProperties.getTransferEntitlementsRetry();
    if (transferEntitlementsRetry != null) {
      RetrySettings transferEntitlementsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.transferEntitlementsSettings().getRetrySettings(),
              transferEntitlementsRetry);
      clientSettingsBuilder
          .transferEntitlementsSettings()
          .setRetrySettings(transferEntitlementsRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for transferEntitlements from properties.");
      }
    }
    Retry transferEntitlementsToGoogleRetry =
        clientProperties.getTransferEntitlementsToGoogleRetry();
    if (transferEntitlementsToGoogleRetry != null) {
      RetrySettings transferEntitlementsToGoogleRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.transferEntitlementsToGoogleSettings().getRetrySettings(),
              transferEntitlementsToGoogleRetry);
      clientSettingsBuilder
          .transferEntitlementsToGoogleSettings()
          .setRetrySettings(transferEntitlementsToGoogleRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for transferEntitlementsToGoogle from properties.");
      }
    }
