...
public class CloudChannelReportsServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a CloudChannelReportsServiceSettings bean configured to use a
   * DefaultCredentialsProvider and the client library's default transport channel provider
   * (defaultCloudChannelReportsServiceTransportChannelProvider()). It also configures the quota
