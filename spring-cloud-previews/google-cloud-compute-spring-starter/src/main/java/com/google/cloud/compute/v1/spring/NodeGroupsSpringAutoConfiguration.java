...
/**
 * Auto-configuration for {@link NodeGroupsClient}.
 *
...
@ConditionalOnClass(NodeGroupsClient.class)
@ConditionalOnProperty(
    value = "com.google.cloud.compute.v1.node-groups.enabled",
    matchIfMissing = true)
@EnableConfigurationProperties(NodeGroupsSpringProperties.class)
public class NodeGroupsSpringAutoConfiguration {
  private final NodeGroupsSpringProperties clientProperties;
  private final CredentialsProvider credentialsProvider;
  private static final Log LOGGER = LogFactory.getLog(NodeGroupsSpringAutoConfiguration.class);

  protected NodeGroupsSpringAutoConfiguration(
      NodeGroupsSpringProperties clientProperties, CredentialsProvider credentialsProvider)
      throws IOException {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultNodeGroupsTransportChannelProvider")
  public TransportChannelProvider defaultNodeGroupsTransportChannelProvider() {
    return NodeGroupsSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a NodeGroupsSettings bean configured to use a DefaultCredentialsProvider and the
   * client library's default transport channel provider
   * (defaultNodeGroupsTransportChannelProvider()). It also configures the quota project ID and
   * executor thread count, if provided through properties.
   *
   * <p>Retry settings are also configured from service-level and method-level properties specified
   * in NodeGroupsSpringProperties. Method-level properties will take precedence over service-level
   * properties if available, and client library defaults will be used if neither are specified.
   *
   * @param defaultTransportChannelProvider TransportChannelProvider to use in the settings.
   * @return a {@link NodeGroupsSettings} bean configured with {@link TransportChannelProvider}
   *     bean.
   */
  @Bean
  @ConditionalOnMissingBean
  public NodeGroupsSettings nodeGroupsSettings(
      @Qualifier("defaultNodeGroupsTransportChannelProvider")
          TransportChannelProvider defaultTransportChannelProvider)
      throws IOException {
    NodeGroupsSettings.Builder clientSettingsBuilder = NodeGroupsSettings.newBuilder();
    ...
    if (this.clientProperties.getExecutorThreadCount() != null) {
      ExecutorProvider executorProvider =
          NodeGroupsSettings.defaultExecutorProviderBuilder()
   ...
   *
   * @param nodeGroupsSettings settings to configure an instance of client bean.
   * @return a {@link NodeGroupsClient} bean configured with {@link NodeGroupsSettings}
   */
  @Bean
  @ConditionalOnMissingBean
  public NodeGroupsClient nodeGroupsClient(NodeGroupsSettings nodeGroupsSettings)
      throws IOException {
    return NodeGroupsClient.create(nodeGroupsSettings);
  }

  private HeaderProvider userAgentHeaderProvider() {
    String springLibrary = "spring-autogen-node-groups";
