...
/** Provides default property values for RegionInstanceGroupManagerResizeRequests client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties(
    "com.google.cloud.compute.v1.region-instance-group-manager-resize-requests")
public class RegionInstanceGroupManagerResizeRequestsSpringProperties
