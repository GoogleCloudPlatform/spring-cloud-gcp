...
@ConfigurationProperties("com.google.cloud.compute.v1.region-health-checks")
public class RegionHealthChecksSpringProperties implements CredentialsSupplier {
