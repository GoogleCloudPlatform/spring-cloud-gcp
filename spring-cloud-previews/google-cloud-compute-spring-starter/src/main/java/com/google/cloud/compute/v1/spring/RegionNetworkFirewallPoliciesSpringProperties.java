...
@ConfigurationProperties("com.google.cloud.compute.v1.region-network-firewall-policies")
public class RegionNetworkFirewallPoliciesSpringProperties implements CredentialsSupplier {
