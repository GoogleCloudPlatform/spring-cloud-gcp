...
/** Provides default property values for ReservationSlots client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.reservation-slots")
public class ReservationSlotsSpringProperties implements CredentialsSupplier {
