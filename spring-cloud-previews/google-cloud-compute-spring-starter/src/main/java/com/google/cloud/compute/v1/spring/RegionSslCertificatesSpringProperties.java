...
@ConfigurationProperties("com.google.cloud.compute.v1.region-ssl-certificates")
public class RegionSslCertificatesSpringProperties implements CredentialsSupplier {
