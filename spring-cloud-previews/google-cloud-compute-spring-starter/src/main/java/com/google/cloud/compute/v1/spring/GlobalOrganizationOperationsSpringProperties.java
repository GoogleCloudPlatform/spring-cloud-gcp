...
@ConfigurationProperties("com.google.cloud.compute.v1.global-organization-operations")
public class GlobalOrganizationOperationsSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for delete. If defined, this takes precedence
   * over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteRetry;
  /**
  ...
  public Retry getDeleteRetry() {
    return this.deleteRetry;
  }

  public void setDeleteRetry(Retry deleteRetry) {
    this.deleteRetry = deleteRetry;
  }
