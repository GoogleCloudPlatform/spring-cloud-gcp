...
/**
 * Auto-configuration for {@link NetworkEndpointGroupsClient}.
 *
...
@ConditionalOnClass(NetworkEndpointGroupsClient.class)
@ConditionalOnProperty(
    value = "com.google.cloud.compute.v1.network-endpoint-groups.enabled",
    matchIfMissing = true)
@EnableConfigurationProperties(NetworkEndpointGroupsSpringProperties.class)
public class NetworkEndpointGroupsSpringAutoConfiguration {
  private final NetworkEndpointGroupsSpringProperties clientProperties;
  private final CredentialsProvider credentialsProvider;
  private static final Log LOGGER =
      LogFactory.getLog(NetworkEndpointGroupsSpringAutoConfiguration.class);

  protected NetworkEndpointGroupsSpringAutoConfiguration(
      NetworkEndpointGroupsSpringProperties clientProperties,
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultNetworkEndpointGroupsTransportChannelProvider")
  public TransportChannelProvider defaultNetworkEndpointGroupsTransportChannelProvider() {
    return NetworkEndpointGroupsSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a NetworkEndpointGroupsSettings bean configured to use a DefaultCredentialsProvider
   * and the client library's default transport channel provider
   * (defaultNetworkEndpointGroupsTransportChannelProvider()). It also configures the quota project
   * ID and executor thread count, if provided through properties.
   *
   * <p>Retry settings are also configured from service-level and method-level properties specified
   * in NetworkEndpointGroupsSpringProperties. Method-level properties will take precedence over
   * service-level properties if available, and client library defaults will be used if neither are
   * specified.
   *
   * @param defaultTransportChannelProvider TransportChannelProvider to use in the settings.
   * @return a {@link NetworkEndpointGroupsSettings} bean configured with {@link
   *     TransportChannelProvider} bean.
   */
  @Bean
  @ConditionalOnMissingBean
  public NetworkEndpointGroupsSettings networkEndpointGroupsSettings(
      @Qualifier("defaultNetworkEndpointGroupsTransportChannelProvider")
          TransportChannelProvider defaultTransportChannelProvider)
      throws IOException {
    NetworkEndpointGroupsSettings.Builder clientSettingsBuilder =
    ...
    if (this.clientProperties.getExecutorThreadCount() != null) {
      ExecutorProvider executorProvider =
          NetworkEndpointGroupsSettings.defaultExecutorProviderBuilder()
   ...
   *
   * @param networkEndpointGroupsSettings settings to configure an instance of client bean.
   * @return a {@link NetworkEndpointGroupsClient} bean configured with {@link
   *     NetworkEndpointGroupsSettings}
   */
  @Bean
  @ConditionalOnMissingBean
  public NetworkEndpointGroupsClient networkEndpointGroupsClient(
      NetworkEndpointGroupsSettings networkEndpointGroupsSettings) throws IOException {
    return NetworkEndpointGroupsClient.create(networkEndpointGroupsSettings);
  }

  private HeaderProvider userAgentHeaderProvider() {
    String springLibrary = "spring-autogen-network-endpoint-groups";
