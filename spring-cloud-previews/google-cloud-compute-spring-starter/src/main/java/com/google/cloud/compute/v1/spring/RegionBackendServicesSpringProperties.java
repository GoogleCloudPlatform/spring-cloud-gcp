...
@ConfigurationProperties("com.google.cloud.compute.v1.region-backend-services")
public class RegionBackendServicesSpringProperties implements CredentialsSupplier {
