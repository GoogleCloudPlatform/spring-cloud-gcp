...
/**
 * Auto-configuration for {@link AddressesClient}.
 *
...
@ConditionalOnClass(AddressesClient.class)
@ConditionalOnProperty(
    value = "com.google.cloud.compute.v1.addresses.enabled",
    matchIfMissing = true)
@EnableConfigurationProperties(AddressesSpringProperties.class)
public class AddressesSpringAutoConfiguration {
  private final AddressesSpringProperties clientProperties;
  private final CredentialsProvider credentialsProvider;
  private static final Log LOGGER = LogFactory.getLog(AddressesSpringAutoConfiguration.class);

  protected AddressesSpringAutoConfiguration(
      AddressesSpringProperties clientProperties, CredentialsProvider credentialsProvider)
      throws IOException {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultAddressesTransportChannelProvider")
  public TransportChannelProvider defaultAddressesTransportChannelProvider() {
    return AddressesSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a AddressesSettings bean configured to use a DefaultCredentialsProvider and the client
   * library's default transport channel provider (defaultAddressesTransportChannelProvider()). It
   * also configures the quota project ID and executor thread count, if provided through properties.
   *
   * <p>Retry settings are also configured from service-level and method-level properties specified
   * in AddressesSpringProperties. Method-level properties will take precedence over service-level
   * properties if available, and client library defaults will be used if neither are specified.
   *
   * @param defaultTransportChannelProvider TransportChannelProvider to use in the settings.
   * @return a {@link AddressesSettings} bean configured with {@link TransportChannelProvider} bean.
   */
  @Bean
  @ConditionalOnMissingBean
  public AddressesSettings addressesSettings(
      @Qualifier("defaultAddressesTransportChannelProvider")
          TransportChannelProvider defaultTransportChannelProvider)
      throws IOException {
    AddressesSettings.Builder clientSettingsBuilder = AddressesSettings.newBuilder();
    ...
    if (this.clientProperties.getExecutorThreadCount() != null) {
      ExecutorProvider executorProvider =
          AddressesSettings.defaultExecutorProviderBuilder()
   ...
   *
   * @param addressesSettings settings to configure an instance of client bean.
   * @return a {@link AddressesClient} bean configured with {@link AddressesSettings}
   */
  @Bean
  @ConditionalOnMissingBean
  public AddressesClient addressesClient(AddressesSettings addressesSettings) throws IOException {
    return AddressesClient.create(addressesSettings);
  }

  private HeaderProvider userAgentHeaderProvider() {
    String springLibrary = "spring-autogen-addresses";
