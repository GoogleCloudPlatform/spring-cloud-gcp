...
@ConfigurationProperties("com.google.cloud.compute.v1.target-https-proxies")
public class TargetHttpsProxiesSpringProperties implements CredentialsSupplier {
