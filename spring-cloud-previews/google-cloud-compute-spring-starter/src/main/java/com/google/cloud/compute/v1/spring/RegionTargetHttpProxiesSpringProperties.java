...
@ConfigurationProperties("com.google.cloud.compute.v1.region-target-http-proxies")
public class RegionTargetHttpProxiesSpringProperties implements CredentialsSupplier {
