...
@ConfigurationProperties("com.google.cloud.compute.v1.region-target-https-proxies")
public class RegionTargetHttpsProxiesSpringProperties implements CredentialsSupplier {
