...
@ConfigurationProperties("com.google.cloud.compute.v1.interconnect-attachments")
public class InterconnectAttachmentsSpringProperties implements CredentialsSupplier {
