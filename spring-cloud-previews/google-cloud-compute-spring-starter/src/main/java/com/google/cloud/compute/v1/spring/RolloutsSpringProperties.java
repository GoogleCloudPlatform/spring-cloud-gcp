...
/** Provides default property values for Rollouts client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.rollouts")
public class RolloutsSpringProperties implements CredentialsSupplier {
