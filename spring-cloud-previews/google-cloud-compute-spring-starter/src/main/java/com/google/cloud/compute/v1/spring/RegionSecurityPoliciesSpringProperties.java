...
@ConfigurationProperties("com.google.cloud.compute.v1.region-security-policies")
public class RegionSecurityPoliciesSpringProperties implements CredentialsSupplier {
