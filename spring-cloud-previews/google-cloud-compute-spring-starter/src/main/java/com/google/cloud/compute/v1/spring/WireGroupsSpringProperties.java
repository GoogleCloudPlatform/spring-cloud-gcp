...
/** Provides default property values for WireGroups client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.wire-groups")
public class WireGroupsSpringProperties implements CredentialsSupplier {
