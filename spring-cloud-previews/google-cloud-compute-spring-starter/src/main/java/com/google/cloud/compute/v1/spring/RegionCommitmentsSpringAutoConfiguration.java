...
/**
 * Auto-configuration for {@link RegionCommitmentsClient}.
 *
...
@ConditionalOnClass(RegionCommitmentsClient.class)
@ConditionalOnProperty(
    value = "com.google.cloud.compute.v1.region-commitments.enabled",
    matchIfMissing = true)
@EnableConfigurationProperties(RegionCommitmentsSpringProperties.class)
public class RegionCommitmentsSpringAutoConfiguration {
  private final RegionCommitmentsSpringProperties clientProperties;
  private final CredentialsProvider credentialsProvider;
  private static final Log LOGGER =
      LogFactory.getLog(RegionCommitmentsSpringAutoConfiguration.class);

  protected RegionCommitmentsSpringAutoConfiguration(
      RegionCommitmentsSpringProperties clientProperties, CredentialsProvider credentialsProvider)
      throws IOException {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultRegionCommitmentsTransportChannelProvider")
  public TransportChannelProvider defaultRegionCommitmentsTransportChannelProvider() {
    return RegionCommitmentsSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a RegionCommitmentsSettings bean configured to use a DefaultCredentialsProvider and
   * the client library's default transport channel provider
   * (defaultRegionCommitmentsTransportChannelProvider()). It also configures the quota project ID
   * and executor thread count, if provided through properties.
   *
   * <p>Retry settings are also configured from service-level and method-level properties specified
   * in RegionCommitmentsSpringProperties. Method-level properties will take precedence over
   * service-level properties if available, and client library defaults will be used if neither are
   * specified.
   *
   * @param defaultTransportChannelProvider TransportChannelProvider to use in the settings.
   * @return a {@link RegionCommitmentsSettings} bean configured with {@link
   *     TransportChannelProvider} bean.
   */
  @Bean
  @ConditionalOnMissingBean
  public RegionCommitmentsSettings regionCommitmentsSettings(
      @Qualifier("defaultRegionCommitmentsTransportChannelProvider")
          TransportChannelProvider defaultTransportChannelProvider)
      throws IOException {
    RegionCommitmentsSettings.Builder clientSettingsBuilder =
    ...
    if (this.clientProperties.getExecutorThreadCount() != null) {
      ExecutorProvider executorProvider =
          RegionCommitmentsSettings.defaultExecutorProviderBuilder()
   ...
   *
   * @param regionCommitmentsSettings settings to configure an instance of client bean.
   * @return a {@link RegionCommitmentsClient} bean configured with {@link
   *     RegionCommitmentsSettings}
   */
  @Bean
  @ConditionalOnMissingBean
  public RegionCommitmentsClient regionCommitmentsClient(
      RegionCommitmentsSettings regionCommitmentsSettings) throws IOException {
    return RegionCommitmentsClient.create(regionCommitmentsSettings);
  }

  private HeaderProvider userAgentHeaderProvider() {
    String springLibrary = "spring-autogen-region-commitments";
