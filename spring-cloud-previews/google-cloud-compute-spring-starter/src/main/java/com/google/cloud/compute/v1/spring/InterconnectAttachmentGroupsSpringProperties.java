...
/** Provides default property values for InterconnectAttachmentGroups client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.interconnect-attachment-groups")
public class InterconnectAttachmentGroupsSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for getOperationalStatus. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry getOperationalStatusRetry;
  /**
  ...
  public Retry getGetOperationalStatusRetry() {
    return this.getOperationalStatusRetry;
  }

  public void setGetOperationalStatusRetry(Retry getOperationalStatusRetry) {
    this.getOperationalStatusRetry = getOperationalStatusRetry;
  }
