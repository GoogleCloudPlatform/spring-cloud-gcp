...
@ConfigurationProperties("com.google.cloud.compute.v1.vpn-gateways")
public class VpnGatewaysSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for getStatus. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry getStatusRetry;
  /**
  ...
  public Retry getGetStatusRetry() {
    return this.getStatusRetry;
  }

  public void setGetStatusRetry(Retry getStatusRetry) {
