...
/** Provides default property values for CrossSiteNetworks client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.cross-site-networks")
public class CrossSiteNetworksSpringProperties implements CredentialsSupplier {
