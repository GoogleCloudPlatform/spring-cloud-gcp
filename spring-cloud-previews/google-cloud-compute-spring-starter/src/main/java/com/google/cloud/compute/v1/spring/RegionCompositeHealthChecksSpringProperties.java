...
/** Provides default property values for RegionCompositeHealthChecks client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.region-composite-health-checks")
public class RegionCompositeHealthChecksSpringProperties implements CredentialsSupplier {
