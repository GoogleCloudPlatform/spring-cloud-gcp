...
/**
 * Auto-configuration for {@link TargetPoolsClient}.
 *
...
@ConditionalOnClass(TargetPoolsClient.class)
@ConditionalOnProperty(
    value = "com.google.cloud.compute.v1.target-pools.enabled",
    matchIfMissing = true)
@EnableConfigurationProperties(TargetPoolsSpringProperties.class)
public class TargetPoolsSpringAutoConfiguration {
  private final TargetPoolsSpringProperties clientProperties;
  private final CredentialsProvider credentialsProvider;
  private static final Log LOGGER = LogFactory.getLog(TargetPoolsSpringAutoConfiguration.class);

  protected TargetPoolsSpringAutoConfiguration(
      TargetPoolsSpringProperties clientProperties, CredentialsProvider credentialsProvider)
      throws IOException {
    this.clientProperties = clientProperties;
    if (this.clientProperties.getCredentials().hasKey()) {
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Using credentials from TargetPools-specific configuration");
      }
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultTargetPoolsTransportChannelProvider")
  public TransportChannelProvider defaultTargetPoolsTransportChannelProvider() {
    return TargetPoolsSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a TargetPoolsSettings bean configured to use a DefaultCredentialsProvider and the
   * client library's default transport channel provider
   * (defaultTargetPoolsTransportChannelProvider()). It also configures the quota project ID and
   * executor thread count, if provided through properties.
   *
   * <p>Retry settings are also configured from service-level and method-level properties specified
   * in TargetPoolsSpringProperties. Method-level properties will take precedence over service-level
   * properties if available, and client library defaults will be used if neither are specified.
   *
   * @param defaultTransportChannelProvider TransportChannelProvider to use in the settings.
   * @return a {@link TargetPoolsSettings} bean configured with {@link TransportChannelProvider}
   *     bean.
   */
  @Bean
  @ConditionalOnMissingBean
  public TargetPoolsSettings targetPoolsSettings(
      @Qualifier("defaultTargetPoolsTransportChannelProvider")
          TransportChannelProvider defaultTransportChannelProvider)
      throws IOException {
    TargetPoolsSettings.Builder clientSettingsBuilder = TargetPoolsSettings.newBuilder();
    ...
    if (this.clientProperties.getExecutorThreadCount() != null) {
      ExecutorProvider executorProvider =
          TargetPoolsSettings.defaultExecutorProviderBuilder()
   ...
   *
   * @param targetPoolsSettings settings to configure an instance of client bean.
   * @return a {@link TargetPoolsClient} bean configured with {@link TargetPoolsSettings}
   */
  @Bean
  @ConditionalOnMissingBean
  public TargetPoolsClient targetPoolsClient(TargetPoolsSettings targetPoolsSettings)
      throws IOException {
    return TargetPoolsClient.create(targetPoolsSettings);
  }

  private HeaderProvider userAgentHeaderProvider() {
    String springLibrary = "spring-autogen-target-pools";
