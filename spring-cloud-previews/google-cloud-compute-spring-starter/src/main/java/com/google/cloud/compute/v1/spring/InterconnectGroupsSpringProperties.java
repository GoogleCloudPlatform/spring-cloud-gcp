...
/** Provides default property values for InterconnectGroups client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.interconnect-groups")
public class InterconnectGroupsSpringProperties implements CredentialsSupplier {
