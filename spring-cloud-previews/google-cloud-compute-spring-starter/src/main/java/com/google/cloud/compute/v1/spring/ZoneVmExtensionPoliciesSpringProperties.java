...
/** Provides default property values for ZoneVmExtensionPolicies client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.zone-vm-extension-policies")
public class ZoneVmExtensionPoliciesSpringProperties implements CredentialsSupplier {
