...
@ConfigurationProperties("com.google.cloud.compute.v1.region-instance-groups")
public class RegionInstanceGroupsSpringProperties implements CredentialsSupplier {
