...
@ConfigurationProperties("com.google.cloud.compute.v1.network-edge-security-services")
public class NetworkEdgeSecurityServicesSpringProperties implements CredentialsSupplier {
