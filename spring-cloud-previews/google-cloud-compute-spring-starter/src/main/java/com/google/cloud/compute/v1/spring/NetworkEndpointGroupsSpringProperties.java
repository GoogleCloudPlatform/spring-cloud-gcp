...
@ConfigurationProperties("com.google.cloud.compute.v1.network-endpoint-groups")
public class NetworkEndpointGroupsSpringProperties implements CredentialsSupplier {
