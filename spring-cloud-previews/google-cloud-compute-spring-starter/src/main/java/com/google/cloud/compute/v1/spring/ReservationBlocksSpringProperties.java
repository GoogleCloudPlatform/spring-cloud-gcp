...
/** Provides default property values for ReservationBlocks client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.reservation-blocks")
public class ReservationBlocksSpringProperties implements CredentialsSupplier {
