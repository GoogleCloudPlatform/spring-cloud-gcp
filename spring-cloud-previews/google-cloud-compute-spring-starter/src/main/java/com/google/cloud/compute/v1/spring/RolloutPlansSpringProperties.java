...
/** Provides default property values for RolloutPlans client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.rollout-plans")
public class RolloutPlansSpringProperties implements CredentialsSupplier {
