...
@ConfigurationProperties("com.google.cloud.compute.v1.region-target-tcp-proxies")
public class RegionTargetTcpProxiesSpringProperties implements CredentialsSupplier {
