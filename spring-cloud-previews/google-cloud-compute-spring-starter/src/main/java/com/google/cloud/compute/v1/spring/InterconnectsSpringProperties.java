...
@ConfigurationProperties("com.google.cloud.compute.v1.interconnects")
public class InterconnectsSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for getDiagnostics. If defined, this takes
  ...
  public Retry getGetDiagnosticsRetry() {
    return this.getDiagnosticsRetry;
  }
