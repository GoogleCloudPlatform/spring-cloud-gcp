...
@ConfigurationProperties("com.google.cloud.compute.v1.storage-pools")
public class StoragePoolsSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for listDisks. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry listDisksRetry;
  /**
  ...
  public Retry getListDisksRetry() {
    return this.listDisksRetry;
  }

  public void setListDisksRetry(Retry listDisksRetry) {
    this.listDisksRetry = listDisksRetry;
  }
