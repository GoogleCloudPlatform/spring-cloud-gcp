...
/** Provides default property values for ReservationSubBlocks client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.reservation-sub-blocks")
public class ReservationSubBlocksSpringProperties implements CredentialsSupplier {
