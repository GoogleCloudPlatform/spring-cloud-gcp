...
/** Provides default property values for FutureReservations client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.future-reservations")
public class FutureReservationsSpringProperties implements CredentialsSupplier {
