...
/** Provides default property values for RegionSnapshots client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.region-snapshots")
public class RegionSnapshotsSpringProperties implements CredentialsSupplier {
