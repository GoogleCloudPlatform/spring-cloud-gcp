...
/** Provides default property values for RegionInstantSnapshotGroups client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.region-instant-snapshot-groups")
public class RegionInstantSnapshotGroupsSpringProperties implements CredentialsSupplier {
