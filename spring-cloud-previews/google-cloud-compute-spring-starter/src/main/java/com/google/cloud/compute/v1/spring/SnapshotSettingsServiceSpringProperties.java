...
@ConfigurationProperties("com.google.cloud.compute.v1.snapshot-settings-service")
public class SnapshotSettingsServiceSpringProperties implements CredentialsSupplier {
