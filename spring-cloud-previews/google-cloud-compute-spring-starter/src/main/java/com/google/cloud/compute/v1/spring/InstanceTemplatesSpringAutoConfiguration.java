...
/**
 * Auto-configuration for {@link InstanceTemplatesClient}.
 *
...
@ConditionalOnClass(InstanceTemplatesClient.class)
@ConditionalOnProperty(
    value = "com.google.cloud.compute.v1.instance-templates.enabled",
    matchIfMissing = true)
@EnableConfigurationProperties(InstanceTemplatesSpringProperties.class)
public class InstanceTemplatesSpringAutoConfiguration {
  private final InstanceTemplatesSpringProperties clientProperties;
  private final CredentialsProvider credentialsProvider;
  private static final Log LOGGER =
      LogFactory.getLog(InstanceTemplatesSpringAutoConfiguration.class);

  protected InstanceTemplatesSpringAutoConfiguration(
      InstanceTemplatesSpringProperties clientProperties, CredentialsProvider credentialsProvider)
      throws IOException {
    this.clientProperties = clientProperties;
    if (this.clientProperties.getCredentials().hasKey()) {
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Using credentials from InstanceTemplates-specific configuration");
      }
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultInstanceTemplatesTransportChannelProvider")
  public TransportChannelProvider defaultInstanceTemplatesTransportChannelProvider() {
    return InstanceTemplatesSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a InstanceTemplatesSettings bean configured to use a DefaultCredentialsProvider and
   * the client library's default transport channel provider
   * (defaultInstanceTemplatesTransportChannelProvider()). It also configures the quota project ID
   * and executor thread count, if provided through properties.
   *
   * <p>Retry settings are also configured from service-level and method-level properties specified
   * in InstanceTemplatesSpringProperties. Method-level properties will take precedence over
   * service-level properties if available, and client library defaults will be used if neither are
   * specified.
   *
   * @param defaultTransportChannelProvider TransportChannelProvider to use in the settings.
   * @return a {@link InstanceTemplatesSettings} bean configured with {@link
  ...
  public InstanceTemplatesSettings instanceTemplatesSettings(
      ...
      throws IOException {
    InstanceTemplatesSettings.Builder clientSettingsBuilder =
    ...
    if (this.clientProperties.getExecutorThreadCount() != null) {
      ExecutorProvider executorProvider =
          InstanceTemplatesSettings.defaultExecutorProviderBuilder()
   ...
   *
   * @param instanceTemplatesSettings settings to configure an instance of client bean.
   * @return a {@link InstanceTemplatesClient} bean configured with {@link
   *     InstanceTemplatesSettings}
   */
  @Bean
  @ConditionalOnMissingBean
  public InstanceTemplatesClient instanceTemplatesClient(
      InstanceTemplatesSettings instanceTemplatesSettings) throws IOException {
    return InstanceTemplatesClient.create(instanceTemplatesSettings);
  }

  private HeaderProvider userAgentHeaderProvider() {
    String springLibrary = "spring-autogen-instance-templates";
