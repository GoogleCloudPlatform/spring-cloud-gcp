...
/** Provides default property values for RegionBackendBuckets client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.region-backend-buckets")
public class RegionBackendBucketsSpringProperties implements CredentialsSupplier {
