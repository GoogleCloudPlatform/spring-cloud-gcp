...
/** Provides default property values for InstantSnapshotGroups client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.instant-snapshot-groups")
public class InstantSnapshotGroupsSpringProperties implements CredentialsSupplier {
