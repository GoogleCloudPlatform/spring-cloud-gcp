...
@ConfigurationProperties("com.google.cloud.compute.v1.routers")
public class RoutersSpringProperties implements CredentialsSupplier {
   ...
   * over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry previewRetry;
  ...
  public Retry getGetNatMappingInfoRetry() {
    return this.getNatMappingInfoRetry;
  }

  public void setGetNatMappingInfoRetry(Retry getNatMappingInfoRetry) {
  ...
  public void setGetRouterStatusRetry(Retry getRouterStatusRetry) {
    this.getRouterStatusRetry = getRouterStatusRetry;
  }
  ...
  public Retry getPreviewRetry() {
    return this.previewRetry;
  }

  public void setPreviewRetry(Retry previewRetry) {
    this.previewRetry = previewRetry;
  }
}
