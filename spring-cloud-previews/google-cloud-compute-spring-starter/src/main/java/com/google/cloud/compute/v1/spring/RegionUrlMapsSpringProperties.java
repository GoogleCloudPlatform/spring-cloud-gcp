...
@ConfigurationProperties("com.google.cloud.compute.v1.region-url-maps")
public class RegionUrlMapsSpringProperties implements CredentialsSupplier {
   ...
   */
  @NestedConfigurationProperty private Retry validateRetry;
  ...
  public Retry getValidateRetry() {
    return this.validateRetry;
  }

  public void setValidateRetry(Retry validateRetry) {
    this.validateRetry = validateRetry;
  }
}
