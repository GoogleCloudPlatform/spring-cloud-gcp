...
/** Provides default property values for RegionHealthSources client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.region-health-sources")
public class RegionHealthSourcesSpringProperties implements CredentialsSupplier {
