...
/**
 * Auto-configuration for {@link DisksClient}.
 *
...
@ConditionalOnClass(DisksClient.class)
@ConditionalOnProperty(value = "com.google.cloud.compute.v1.disks.enabled", matchIfMissing = true)
@EnableConfigurationProperties(DisksSpringProperties.class)
public class DisksSpringAutoConfiguration {
  private final DisksSpringProperties clientProperties;
  private final CredentialsProvider credentialsProvider;
  private static final Log LOGGER = LogFactory.getLog(DisksSpringAutoConfiguration.class);

  protected DisksSpringAutoConfiguration(
      DisksSpringProperties clientProperties, CredentialsProvider credentialsProvider)
      throws IOException {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultDisksTransportChannelProvider")
  public TransportChannelProvider defaultDisksTransportChannelProvider() {
    return DisksSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a DisksSettings bean configured to use a DefaultCredentialsProvider and the client
   * library's default transport channel provider (defaultDisksTransportChannelProvider()). It also
   * configures the quota project ID and executor thread count, if provided through properties.
   *
   * <p>Retry settings are also configured from service-level and method-level properties specified
   * in DisksSpringProperties. Method-level properties will take precedence over service-level
   * properties if available, and client library defaults will be used if neither are specified.
   *
   * @param defaultTransportChannelProvider TransportChannelProvider to use in the settings.
   * @return a {@link DisksSettings} bean configured with {@link TransportChannelProvider} bean.
   */
  @Bean
  @ConditionalOnMissingBean
  public DisksSettings disksSettings(
      @Qualifier("defaultDisksTransportChannelProvider")
          TransportChannelProvider defaultTransportChannelProvider)
      throws IOException {
    DisksSettings.Builder clientSettingsBuilder = DisksSettings.newBuilder();
    ...
    if (this.clientProperties.getExecutorThreadCount() != null) {
      ExecutorProvider executorProvider =
          DisksSettings.defaultExecutorProviderBuilder()
   ...
   *
   * @param disksSettings settings to configure an instance of client bean.
   * @return a {@link DisksClient} bean configured with {@link DisksSettings}
   */
  @Bean
  @ConditionalOnMissingBean
  public DisksClient disksClient(DisksSettings disksSettings) throws IOException {
    return DisksClient.create(disksSettings);
  }

  private HeaderProvider userAgentHeaderProvider() {
    String springLibrary = "spring-autogen-disks";
