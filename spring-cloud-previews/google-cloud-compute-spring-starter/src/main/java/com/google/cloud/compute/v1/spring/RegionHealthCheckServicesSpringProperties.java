...
@ConfigurationProperties("com.google.cloud.compute.v1.region-health-check-services")
public class RegionHealthCheckServicesSpringProperties implements CredentialsSupplier {
