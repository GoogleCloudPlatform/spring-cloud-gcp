...
@ConfigurationProperties("com.google.cloud.compute.v1.region-ssl-policies")
public class RegionSslPoliciesSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for listAvailableFeatures. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry listAvailableFeaturesRetry;
  ...
  public Retry getListAvailableFeaturesRetry() {
    return this.listAvailableFeaturesRetry;
  }

  public void setListAvailableFeaturesRetry(Retry listAvailableFeaturesRetry) {
    this.listAvailableFeaturesRetry = listAvailableFeaturesRetry;
  }
}
