...
/**
 * Auto-configuration for {@link InstanceGroupsClient}.
 *
...
@ConditionalOnClass(InstanceGroupsClient.class)
@ConditionalOnProperty(
    value = "com.google.cloud.compute.v1.instance-groups.enabled",
    matchIfMissing = true)
@EnableConfigurationProperties(InstanceGroupsSpringProperties.class)
public class InstanceGroupsSpringAutoConfiguration {
  private final InstanceGroupsSpringProperties clientProperties;
  private final CredentialsProvider credentialsProvider;
  private static final Log LOGGER = LogFactory.getLog(InstanceGroupsSpringAutoConfiguration.class);

  protected InstanceGroupsSpringAutoConfiguration(
      InstanceGroupsSpringProperties clientProperties, CredentialsProvider credentialsProvider)
      throws IOException {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultInstanceGroupsTransportChannelProvider")
  public TransportChannelProvider defaultInstanceGroupsTransportChannelProvider() {
    return InstanceGroupsSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a InstanceGroupsSettings bean configured to use a DefaultCredentialsProvider and the
   * client library's default transport channel provider
   * (defaultInstanceGroupsTransportChannelProvider()). It also configures the quota project ID and
   * executor thread count, if provided through properties.
   *
   * <p>Retry settings are also configured from service-level and method-level properties specified
   * in InstanceGroupsSpringProperties. Method-level properties will take precedence over
   * service-level properties if available, and client library defaults will be used if neither are
   * specified.
   *
   * @param defaultTransportChannelProvider TransportChannelProvider to use in the settings.
   * @return a {@link InstanceGroupsSettings} bean configured with {@link TransportChannelProvider}
   *     bean.
   */
  @Bean
  @ConditionalOnMissingBean
  public InstanceGroupsSettings instanceGroupsSettings(
      @Qualifier("defaultInstanceGroupsTransportChannelProvider")
          TransportChannelProvider defaultTransportChannelProvider)
      throws IOException {
    InstanceGroupsSettings.Builder clientSettingsBuilder = InstanceGroupsSettings.newBuilder();
    ...
    if (this.clientProperties.getExecutorThreadCount() != null) {
      ExecutorProvider executorProvider =
          InstanceGroupsSettings.defaultExecutorProviderBuilder()
   ...
   *
   * @param instanceGroupsSettings settings to configure an instance of client bean.
   * @return a {@link InstanceGroupsClient} bean configured with {@link InstanceGroupsSettings}
   */
  @Bean
  @ConditionalOnMissingBean
  public InstanceGroupsClient instanceGroupsClient(InstanceGroupsSettings instanceGroupsSettings)
      throws IOException {
    return InstanceGroupsClient.create(instanceGroupsSettings);
  }

  private HeaderProvider userAgentHeaderProvider() {
    String springLibrary = "spring-autogen-instance-groups";
