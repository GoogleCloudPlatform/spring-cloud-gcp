...
public class ImagesSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for getFromFamily. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry getFromFamilyRetry;
  /**
  ...
  public Retry getGetFromFamilyRetry() {
    return this.getFromFamilyRetry;
  }

  public void setGetFromFamilyRetry(Retry getFromFamilyRetry) {
    this.getFromFamilyRetry = getFromFamilyRetry;
  }
