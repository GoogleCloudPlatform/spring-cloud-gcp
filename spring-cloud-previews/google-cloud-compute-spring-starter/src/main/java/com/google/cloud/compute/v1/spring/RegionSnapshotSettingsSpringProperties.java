...
/** Provides default property values for RegionSnapshotSettings client bean */
@Generated("by google-cloud-spring-generator")
@BetaApi("Autogenerated Spring autoconfiguration is not yet stable")
@ConfigurationProperties("com.google.cloud.compute.v1.region-snapshot-settings")
public class RegionSnapshotSettingsSpringProperties implements CredentialsSupplier {
