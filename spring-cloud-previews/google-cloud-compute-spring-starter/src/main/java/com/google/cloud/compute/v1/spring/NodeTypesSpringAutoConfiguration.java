...
/**
 * Auto-configuration for {@link NodeTypesClient}.
 *
...
@ConditionalOnClass(NodeTypesClient.class)
@ConditionalOnProperty(
    value = "com.google.cloud.compute.v1.node-types.enabled",
    matchIfMissing = true)
@EnableConfigurationProperties(NodeTypesSpringProperties.class)
public class NodeTypesSpringAutoConfiguration {
  private final NodeTypesSpringProperties clientProperties;
  private final CredentialsProvider credentialsProvider;
  private static final Log LOGGER = LogFactory.getLog(NodeTypesSpringAutoConfiguration.class);

  protected NodeTypesSpringAutoConfiguration(
      NodeTypesSpringProperties clientProperties, CredentialsProvider credentialsProvider)
      throws IOException {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultNodeTypesTransportChannelProvider")
  public TransportChannelProvider defaultNodeTypesTransportChannelProvider() {
    return NodeTypesSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a NodeTypesSettings bean configured to use a DefaultCredentialsProvider and the client
   * library's default transport channel provider (defaultNodeTypesTransportChannelProvider()). It
   * also configures the quota project ID and executor thread count, if provided through properties.
   *
   * <p>Retry settings are also configured from service-level and method-level properties specified
   * in NodeTypesSpringProperties. Method-level properties will take precedence over service-level
   * properties if available, and client library defaults will be used if neither are specified.
   *
   * @param defaultTransportChannelProvider TransportChannelProvider to use in the settings.
   * @return a {@link NodeTypesSettings} bean configured with {@link TransportChannelProvider} bean.
   */
  @Bean
  @ConditionalOnMissingBean
  public NodeTypesSettings nodeTypesSettings(
      @Qualifier("defaultNodeTypesTransportChannelProvider")
          TransportChannelProvider defaultTransportChannelProvider)
      throws IOException {
    NodeTypesSettings.Builder clientSettingsBuilder = NodeTypesSettings.newBuilder();
    ...
    if (this.clientProperties.getExecutorThreadCount() != null) {
      ExecutorProvider executorProvider =
          NodeTypesSettings.defaultExecutorProviderBuilder()
   ...
   *
   * @param nodeTypesSettings settings to configure an instance of client bean.
   * @return a {@link NodeTypesClient} bean configured with {@link NodeTypesSettings}
   */
  @Bean
  @ConditionalOnMissingBean
  public NodeTypesClient nodeTypesClient(NodeTypesSettings nodeTypesSettings) throws IOException {
    return NodeTypesClient.create(nodeTypesSettings);
  }

  private HeaderProvider userAgentHeaderProvider() {
    String springLibrary = "spring-autogen-node-types";
