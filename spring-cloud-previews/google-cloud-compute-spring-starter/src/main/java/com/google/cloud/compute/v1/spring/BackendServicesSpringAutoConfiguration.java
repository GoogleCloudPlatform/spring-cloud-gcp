...
/**
 * Auto-configuration for {@link BackendServicesClient}.
 *
...
@ConditionalOnClass(BackendServicesClient.class)
@ConditionalOnProperty(
    value = "com.google.cloud.compute.v1.backend-services.enabled",
    matchIfMissing = true)
@EnableConfigurationProperties(BackendServicesSpringProperties.class)
public class BackendServicesSpringAutoConfiguration {
  private final BackendServicesSpringProperties clientProperties;
  private final CredentialsProvider credentialsProvider;
  private static final Log LOGGER = LogFactory.getLog(BackendServicesSpringAutoConfiguration.class);

  protected BackendServicesSpringAutoConfiguration(
      BackendServicesSpringProperties clientProperties, CredentialsProvider credentialsProvider)
      throws IOException {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultBackendServicesTransportChannelProvider")
  public TransportChannelProvider defaultBackendServicesTransportChannelProvider() {
    return BackendServicesSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a BackendServicesSettings bean configured to use a DefaultCredentialsProvider and the
   * client library's default transport channel provider
   * (defaultBackendServicesTransportChannelProvider()). It also configures the quota project ID and
   * executor thread count, if provided through properties.
   *
   * <p>Retry settings are also configured from service-level and method-level properties specified
   * in BackendServicesSpringProperties. Method-level properties will take precedence over
   * service-level properties if available, and client library defaults will be used if neither are
   * specified.
   *
   * @param defaultTransportChannelProvider TransportChannelProvider to use in the settings.
   * @return a {@link BackendServicesSettings} bean configured with {@link TransportChannelProvider}
   *     bean.
   */
  @Bean
  @ConditionalOnMissingBean
  public BackendServicesSettings backendServicesSettings(
      @Qualifier("defaultBackendServicesTransportChannelProvider")
          TransportChannelProvider defaultTransportChannelProvider)
      throws IOException {
    BackendServicesSettings.Builder clientSettingsBuilder = BackendServicesSettings.newBuilder();
    ...
    if (this.clientProperties.getExecutorThreadCount() != null) {
      ExecutorProvider executorProvider =
          BackendServicesSettings.defaultExecutorProviderBuilder()
   ...
   *
   * @param backendServicesSettings settings to configure an instance of client bean.
   * @return a {@link BackendServicesClient} bean configured with {@link BackendServicesSettings}
   */
  @Bean
  @ConditionalOnMissingBean
  public BackendServicesClient backendServicesClient(
      BackendServicesSettings backendServicesSettings) throws IOException {
    return BackendServicesClient.create(backendServicesSettings);
  }

  private HeaderProvider userAgentHeaderProvider() {
    String springLibrary = "spring-autogen-backend-services";
