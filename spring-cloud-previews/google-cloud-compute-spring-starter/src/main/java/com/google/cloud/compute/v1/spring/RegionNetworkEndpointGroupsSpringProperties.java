...
@ConfigurationProperties("com.google.cloud.compute.v1.region-network-endpoint-groups")
public class RegionNetworkEndpointGroupsSpringProperties implements CredentialsSupplier {
