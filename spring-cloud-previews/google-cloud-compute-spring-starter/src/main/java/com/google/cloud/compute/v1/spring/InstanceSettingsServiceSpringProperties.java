...
@ConfigurationProperties("com.google.cloud.compute.v1.instance-settings-service")
public class InstanceSettingsServiceSpringProperties implements CredentialsSupplier {
