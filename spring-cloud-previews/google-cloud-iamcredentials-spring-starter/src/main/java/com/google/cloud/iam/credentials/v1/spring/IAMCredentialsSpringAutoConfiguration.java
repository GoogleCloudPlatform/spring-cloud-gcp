...
@ConditionalOnProperty(
    value = "com.google.cloud.iam.credentials.v1.spring.auto.i-a-m-credentials.enabled",
    matchIfMissing = true)
...
public class IAMCredentialsSpringAutoConfiguration {
  ...
  /**
   * Provides a IAMCredentialsClient bean configured to use the default credentials provider
