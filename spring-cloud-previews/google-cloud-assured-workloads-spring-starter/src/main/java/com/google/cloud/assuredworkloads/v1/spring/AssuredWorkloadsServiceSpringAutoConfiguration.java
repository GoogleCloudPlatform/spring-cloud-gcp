...
public class AssuredWorkloadsServiceSpringAutoConfiguration {
  ...
  public AssuredWorkloadsServiceSettings assuredWorkloadsServiceSettings(
    ...
    if (serviceRetry != null) {
      RetrySettings createWorkloadRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createWorkloadSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder.createWorkloadSettings().setRetrySettings(createWorkloadRetrySettings);
    ...
    Retry createWorkloadRetry = clientProperties.getCreateWorkloadRetry();
    if (createWorkloadRetry != null) {
      RetrySettings createWorkloadRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createWorkloadSettings().getRetrySettings(),
              createWorkloadRetry);
      clientSettingsBuilder.createWorkloadSettings().setRetrySettings(createWorkloadRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for createWorkload from properties.");
      }
    }
