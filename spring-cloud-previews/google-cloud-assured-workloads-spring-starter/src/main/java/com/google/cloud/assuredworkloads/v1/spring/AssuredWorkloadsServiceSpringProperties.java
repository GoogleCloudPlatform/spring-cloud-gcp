...
public class AssuredWorkloadsServiceSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for createWorkload. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createWorkloadRetry;
  /**
  ...
  public Retry getCreateWorkloadRetry() {
    return this.createWorkloadRetry;
  }

  public void setCreateWorkloadRetry(Retry createWorkloadRetry) {
    this.createWorkloadRetry = createWorkloadRetry;
  }
