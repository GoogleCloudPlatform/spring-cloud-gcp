...
public class SpeechSpringAutoConfiguration {
  ...
  /**
   * Provides a SpeechSettings bean configured to use the default credentials provider (obtained
   * with speechCredentials()) and its default transport channel provider
