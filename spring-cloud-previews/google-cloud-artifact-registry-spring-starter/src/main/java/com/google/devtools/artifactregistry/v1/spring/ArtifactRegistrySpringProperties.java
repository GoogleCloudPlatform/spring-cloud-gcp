...
public class ArtifactRegistrySpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for importAptArtifacts. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry importAptArtifactsRetry;
  /**
   * Allow override of retry settings at method-level for importYumArtifacts. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry importYumArtifactsRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for createRepository. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createRepositoryRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for deleteRepository. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteRepositoryRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for deletePackage. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deletePackageRetry;
  /**
  ...
  public Retry getImportAptArtifactsRetry() {
    return this.importAptArtifactsRetry;
  }

  public void setImportAptArtifactsRetry(Retry importAptArtifactsRetry) {
    this.importAptArtifactsRetry = importAptArtifactsRetry;
  }

  public Retry getImportYumArtifactsRetry() {
    return this.importYumArtifactsRetry;
  }

  public void setImportYumArtifactsRetry(Retry importYumArtifactsRetry) {
    this.importYumArtifactsRetry = importYumArtifactsRetry;
  }
  ...
  public Retry getCreateRepositoryRetry() {
    return this.createRepositoryRetry;
  }

  public void setCreateRepositoryRetry(Retry createRepositoryRetry) {
    this.createRepositoryRetry = createRepositoryRetry;
  }
  ...
  public Retry getDeleteRepositoryRetry() {
    return this.deleteRepositoryRetry;
  }

  public void setDeleteRepositoryRetry(Retry deleteRepositoryRetry) {
    this.deleteRepositoryRetry = deleteRepositoryRetry;
  }
  ...
  public Retry getDeletePackageRetry() {
    return this.deletePackageRetry;
  }

  public void setDeletePackageRetry(Retry deletePackageRetry) {
    this.deletePackageRetry = deletePackageRetry;
  }
