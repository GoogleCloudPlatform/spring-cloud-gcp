...
public class ArtifactRegistrySpringAutoConfiguration {
  ...
  public ArtifactRegistrySettings artifactRegistrySettings(
    ...
    if (serviceRetry != null) {
      ...
      RetrySettings importAptArtifactsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.importAptArtifactsSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .importAptArtifactsSettings()
          .setRetrySettings(importAptArtifactsRetrySettings);

      RetrySettings importYumArtifactsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.importYumArtifactsSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .importYumArtifactsSettings()
          .setRetrySettings(importYumArtifactsRetrySettings);
      ...
      RetrySettings createRepositoryRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createRepositorySettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .createRepositorySettings()
          .setRetrySettings(createRepositoryRetrySettings);
      ...
      RetrySettings deleteRepositoryRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteRepositorySettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .deleteRepositorySettings()
          .setRetrySettings(deleteRepositoryRetrySettings);
      ...
      RetrySettings deletePackageRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deletePackageSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder.deletePackageSettings().setRetrySettings(deletePackageRetrySettings);
    ...
    Retry importAptArtifactsRetry = clientProperties.getImportAptArtifactsRetry();
    if (importAptArtifactsRetry != null) {
      RetrySettings importAptArtifactsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.importAptArtifactsSettings().getRetrySettings(),
              importAptArtifactsRetry);
      clientSettingsBuilder
          .importAptArtifactsSettings()
          .setRetrySettings(importAptArtifactsRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for importAptArtifacts from properties.");
      }
    }
    Retry importYumArtifactsRetry = clientProperties.getImportYumArtifactsRetry();
    if (importYumArtifactsRetry != null) {
      RetrySettings importYumArtifactsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.importYumArtifactsSettings().getRetrySettings(),
              importYumArtifactsRetry);
      clientSettingsBuilder
          .importYumArtifactsSettings()
          .setRetrySettings(importYumArtifactsRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for importYumArtifacts from properties.");
      }
    }
    ...
    Retry createRepositoryRetry = clientProperties.getCreateRepositoryRetry();
    if (createRepositoryRetry != null) {
      RetrySettings createRepositoryRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createRepositorySettings().getRetrySettings(),
              createRepositoryRetry);
      clientSettingsBuilder
          .createRepositorySettings()
          .setRetrySettings(createRepositoryRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for createRepository from properties.");
      }
    }
    ...
    Retry deleteRepositoryRetry = clientProperties.getDeleteRepositoryRetry();
    if (deleteRepositoryRetry != null) {
      RetrySettings deleteRepositoryRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteRepositorySettings().getRetrySettings(),
              deleteRepositoryRetry);
      clientSettingsBuilder
          .deleteRepositorySettings()
          .setRetrySettings(deleteRepositoryRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deleteRepository from properties.");
      }
    }
    ...
    Retry deletePackageRetry = clientProperties.getDeletePackageRetry();
    if (deletePackageRetry != null) {
      RetrySettings deletePackageRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deletePackageSettings().getRetrySettings(), deletePackageRetry);
      clientSettingsBuilder.deletePackageSettings().setRetrySettings(deletePackageRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for deletePackage from properties.");
      }
    }
