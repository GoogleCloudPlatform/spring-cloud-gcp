...
public class ImageVersionsSpringAutoConfiguration {
  ...
  /**
   * Provides a ImageVersionsSettings bean configured to use a DefaultCredentialsProvider and the
   * client library's default transport channel provider
   * (defaultImageVersionsTransportChannelProvider()). It also configures the quota project ID and
