...
@ConditionalOnProperty(
    value = "com.google.cloud.orchestration.airflow.service.v1.spring.auto.image-versions.enabled",
    matchIfMissing = true)
...
public class ImageVersionsSpringAutoConfiguration {
  ...
  /**
   * Provides a ImageVersionsClient bean configured to use the default credentials provider
