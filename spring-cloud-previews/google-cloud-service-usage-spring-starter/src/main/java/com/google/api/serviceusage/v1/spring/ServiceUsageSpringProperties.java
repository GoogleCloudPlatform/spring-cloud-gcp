...
public class ServiceUsageSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for enableService. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry enableServiceRetry;
  /**
   * Allow override of retry settings at method-level for disableService. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry disableServiceRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for batchEnableServices. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry batchEnableServicesRetry;
  /**
  ...
  public Retry getEnableServiceRetry() {
    return this.enableServiceRetry;
  }

  public void setEnableServiceRetry(Retry enableServiceRetry) {
    this.enableServiceRetry = enableServiceRetry;
  }

  public Retry getDisableServiceRetry() {
    return this.disableServiceRetry;
  }

  public void setDisableServiceRetry(Retry disableServiceRetry) {
    this.disableServiceRetry = disableServiceRetry;
  }
  ...
  public Retry getBatchEnableServicesRetry() {
    return this.batchEnableServicesRetry;
  }

  public void setBatchEnableServicesRetry(Retry batchEnableServicesRetry) {
    this.batchEnableServicesRetry = batchEnableServicesRetry;
  }
