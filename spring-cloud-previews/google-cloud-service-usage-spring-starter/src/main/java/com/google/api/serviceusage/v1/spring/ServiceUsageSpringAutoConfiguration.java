...
public class ServiceUsageSpringAutoConfiguration {
  ...
  /**
   * Provides a ServiceUsageSettings bean configured to use the default credentials provider
   * (obtained with serviceUsageCredentials()) and its default transport channel provider
