...
public class PredictionServiceSpringAutoConfiguration {
  ...
  public PredictionServiceSettings predictionServiceSettings(
    ...
    if (serviceRetry != null) {
      ...
      RetrySettings batchPredictRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.batchPredictSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder.batchPredictSettings().setRetrySettings(batchPredictRetrySettings);
    ...
    Retry batchPredictRetry = clientProperties.getBatchPredictRetry();
    if (batchPredictRetry != null) {
      RetrySettings batchPredictRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.batchPredictSettings().getRetrySettings(), batchPredictRetry);
      clientSettingsBuilder.batchPredictSettings().setRetrySettings(batchPredictRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for batchPredict from properties.");
      }
    }
