...
public class PredictionServiceSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for batchPredict. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry batchPredictRetry;
  ...
  public Retry getBatchPredictRetry() {
    return this.batchPredictRetry;
  }

  public void setBatchPredictRetry(Retry batchPredictRetry) {
    this.batchPredictRetry = batchPredictRetry;
  }
}
