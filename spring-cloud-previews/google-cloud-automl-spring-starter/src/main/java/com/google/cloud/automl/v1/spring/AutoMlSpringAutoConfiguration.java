...
public class AutoMlSpringAutoConfiguration {
  ...
  /**
   * Provides a AutoMlSettings bean configured to use the default credentials provider (obtained
   * with autoMlCredentials()) and its default transport channel provider
