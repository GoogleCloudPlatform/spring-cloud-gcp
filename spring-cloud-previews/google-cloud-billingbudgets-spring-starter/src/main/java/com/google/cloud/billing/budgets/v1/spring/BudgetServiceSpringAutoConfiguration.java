...
@ConditionalOnProperty(
    value = "com.google.cloud.billing.budgets.v1.spring.auto.budget-service.enabled",
    matchIfMissing = true)
...
public class BudgetServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a BudgetServiceClient bean configured to use the default credentials provider
   * (obtained with budgetServiceCredentials()) and its default transport channel provider
   * (defaultBudgetServiceTransportChannelProvider()). It also configures the quota project ID if
