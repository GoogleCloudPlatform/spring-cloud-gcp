...
public class StorageTransferServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a StorageTransferServiceSettings bean configured to use the default credentials
   * provider (obtained with storageTransferServiceCredentials()) and its default transport channel
   * provider (defaultStorageTransferServiceTransportChannelProvider()). It also configures the
