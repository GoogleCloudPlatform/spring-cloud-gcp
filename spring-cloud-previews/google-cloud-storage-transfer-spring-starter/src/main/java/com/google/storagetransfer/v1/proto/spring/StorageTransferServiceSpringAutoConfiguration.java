...
public class StorageTransferServiceSpringAutoConfiguration {
  ...
  public StorageTransferServiceSettings storageTransferServiceSettings(
    ...
    if (serviceRetry != null) {
      ...
      RetrySettings runTransferJobRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.runTransferJobSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder.runTransferJobSettings().setRetrySettings(runTransferJobRetrySettings);
    ...
    Retry runTransferJobRetry = clientProperties.getRunTransferJobRetry();
    if (runTransferJobRetry != null) {
      RetrySettings runTransferJobRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.runTransferJobSettings().getRetrySettings(),
              runTransferJobRetry);
      clientSettingsBuilder.runTransferJobSettings().setRetrySettings(runTransferJobRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for runTransferJob from properties.");
      }
    }
