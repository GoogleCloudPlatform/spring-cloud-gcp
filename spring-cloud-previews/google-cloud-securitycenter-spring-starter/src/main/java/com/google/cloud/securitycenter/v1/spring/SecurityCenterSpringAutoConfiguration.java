...
public class SecurityCenterSpringAutoConfiguration {
  ...
  public SecurityCenterSettings securityCenterSettings(
    ...
    if (serviceRetry != null) {
      RetrySettings bulkMuteFindingsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.bulkMuteFindingsSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .bulkMuteFindingsSettings()
          .setRetrySettings(bulkMuteFindingsRetrySettings);
      ...
      RetrySettings runAssetDiscoveryRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.runAssetDiscoverySettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .runAssetDiscoverySettings()
          .setRetrySettings(runAssetDiscoveryRetrySettings);
    ...
    Retry bulkMuteFindingsRetry = clientProperties.getBulkMuteFindingsRetry();
    if (bulkMuteFindingsRetry != null) {
      RetrySettings bulkMuteFindingsRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.bulkMuteFindingsSettings().getRetrySettings(),
              bulkMuteFindingsRetry);
      clientSettingsBuilder
          .bulkMuteFindingsSettings()
          .setRetrySettings(bulkMuteFindingsRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for bulkMuteFindings from properties.");
      }
    }
    ...
    Retry runAssetDiscoveryRetry = clientProperties.getRunAssetDiscoveryRetry();
    if (runAssetDiscoveryRetry != null) {
      RetrySettings runAssetDiscoveryRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.runAssetDiscoverySettings().getRetrySettings(),
              runAssetDiscoveryRetry);
      clientSettingsBuilder
          .runAssetDiscoverySettings()
          .setRetrySettings(runAssetDiscoveryRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for runAssetDiscovery from properties.");
      }
    }
