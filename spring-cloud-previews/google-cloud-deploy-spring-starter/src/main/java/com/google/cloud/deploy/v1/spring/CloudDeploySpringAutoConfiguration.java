...
public class CloudDeploySpringAutoConfiguration {
  ...
  /**
   * Provides a CloudDeploySettings bean configured to use the default credentials provider
   * (obtained with cloudDeployCredentials()) and its default transport channel provider
