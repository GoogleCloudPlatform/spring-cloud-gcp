...
@ConfigurationProperties("com.google.cloud.deploy.v1.spring.auto.cloud-deploy")
public class CloudDeploySpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for createDeliveryPipeline. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createDeliveryPipelineRetry;
  /**
   * Allow override of retry settings at method-level for updateDeliveryPipeline. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry updateDeliveryPipelineRetry;
  /**
   * Allow override of retry settings at method-level for deleteDeliveryPipeline. If defined, this
   * takes precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteDeliveryPipelineRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for createTarget. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createTargetRetry;
  /**
   * Allow override of retry settings at method-level for updateTarget. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry updateTargetRetry;
  /**
   * Allow override of retry settings at method-level for deleteTarget. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteTargetRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for createRelease. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createReleaseRetry;
  /**
  ...
  /**
   * Allow override of retry settings at method-level for createRollout. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createRolloutRetry;
  /**
  ...
  public Retry getCreateDeliveryPipelineRetry() {
    return this.createDeliveryPipelineRetry;
  }

  public void setCreateDeliveryPipelineRetry(Retry createDeliveryPipelineRetry) {
    this.createDeliveryPipelineRetry = createDeliveryPipelineRetry;
  }

  public Retry getUpdateDeliveryPipelineRetry() {
    return this.updateDeliveryPipelineRetry;
  }

  public void setUpdateDeliveryPipelineRetry(Retry updateDeliveryPipelineRetry) {
    this.updateDeliveryPipelineRetry = updateDeliveryPipelineRetry;
  }

  public Retry getDeleteDeliveryPipelineRetry() {
    return this.deleteDeliveryPipelineRetry;
  }

  public void setDeleteDeliveryPipelineRetry(Retry deleteDeliveryPipelineRetry) {
    this.deleteDeliveryPipelineRetry = deleteDeliveryPipelineRetry;
  }
  ...
  public Retry getCreateTargetRetry() {
    return this.createTargetRetry;
  }

  public void setCreateTargetRetry(Retry createTargetRetry) {
    this.createTargetRetry = createTargetRetry;
  }

  public Retry getUpdateTargetRetry() {
    return this.updateTargetRetry;
  }

  public void setUpdateTargetRetry(Retry updateTargetRetry) {
    this.updateTargetRetry = updateTargetRetry;
  }

  public Retry getDeleteTargetRetry() {
    return this.deleteTargetRetry;
  }

  public void setDeleteTargetRetry(Retry deleteTargetRetry) {
    this.deleteTargetRetry = deleteTargetRetry;
  }
  ...
  public Retry getCreateReleaseRetry() {
    return this.createReleaseRetry;
  }

  public void setCreateReleaseRetry(Retry createReleaseRetry) {
    this.createReleaseRetry = createReleaseRetry;
  }
  ...
  public Retry getCreateRolloutRetry() {
    return this.createRolloutRetry;
  }

  public void setCreateRolloutRetry(Retry createRolloutRetry) {
    this.createRolloutRetry = createRolloutRetry;
  }
