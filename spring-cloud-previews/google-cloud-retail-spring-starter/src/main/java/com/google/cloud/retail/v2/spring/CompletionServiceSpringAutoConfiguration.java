...
public class CompletionServiceSpringAutoConfiguration {
  ...
  public CompletionServiceSettings completionServiceSettings(
    ...
    if (serviceRetry != null) {
      ...
      RetrySettings importCompletionDataRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.importCompletionDataSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .importCompletionDataSettings()
          .setRetrySettings(importCompletionDataRetrySettings);
    ...
    Retry importCompletionDataRetry = clientProperties.getImportCompletionDataRetry();
    if (importCompletionDataRetry != null) {
      RetrySettings importCompletionDataRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.importCompletionDataSettings().getRetrySettings(),
              importCompletionDataRetry);
      clientSettingsBuilder
          .importCompletionDataSettings()
          .setRetrySettings(importCompletionDataRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for importCompletionData from properties.");
      }
    }
