...
@ConditionalOnProperty(
    value = "com.google.cloud.retail.v2.user-event-service.enabled",
    matchIfMissing = true)
...
public class UserEventServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a UserEventServiceSettings bean configured to use the default credentials provider
