...
public class GkeHubSpringAutoConfiguration {
  ...
  /**
   * Provides a GkeHubSettings bean configured to use the default credentials provider (obtained
   * with gkeHubCredentials()) and its default transport channel provider
