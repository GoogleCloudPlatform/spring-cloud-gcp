...
public class TraceServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a TraceServiceSettings bean configured to use the default credentials provider
   * (obtained with traceServiceCredentials()) and its default transport channel provider
