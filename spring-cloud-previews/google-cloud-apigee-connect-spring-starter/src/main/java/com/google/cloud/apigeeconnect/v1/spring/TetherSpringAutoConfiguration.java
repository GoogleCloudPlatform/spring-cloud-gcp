...
@ConditionalOnProperty(
    value = "com.google.cloud.apigeeconnect.v1.tether.enabled",
    matchIfMissing = true)
...
public class TetherSpringAutoConfiguration {
  ...
  /**
   * Provides a TetherSettings bean configured to use the default credentials provider (obtained
   * with tetherCredentials()) and its default transport channel provider
