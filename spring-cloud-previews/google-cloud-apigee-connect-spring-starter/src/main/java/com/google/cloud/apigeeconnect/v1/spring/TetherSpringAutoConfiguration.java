...
public class TetherSpringAutoConfiguration {
  ...
  /**
   * Provides a TetherSettings bean configured to use a DefaultCredentialsProvider and the client
   * library's default transport channel provider (defaultTetherTransportChannelProvider()). It also
