...
@ConditionalOnProperty(
    value = "com.google.cloud.videointelligence.v1.video-intelligence-service.enabled",
    matchIfMissing = true)
...
public class VideoIntelligenceServiceSpringAutoConfiguration {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultVideoIntelligenceServiceTransportChannelProvider")
  public TransportChannelProvider defaultVideoIntelligenceServiceTransportChannelProvider() {
    if (this.clientProperties.getUseRest()) {
      return VideoIntelligenceServiceSettings.defaultHttpJsonTransportProviderBuilder().build();
    }
    return VideoIntelligenceServiceSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a VideoIntelligenceServiceSettings bean configured to use a DefaultCredentialsProvider
   * and the client library's default transport channel provider
   * (defaultVideoIntelligenceServiceTransportChannelProvider()). It also configures the quota
