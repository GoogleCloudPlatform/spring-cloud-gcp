...
@ConditionalOnProperty(
    ...
    matchIfMissing = true)
@EnableConfigurationProperties(VideoIntelligenceServiceSpringProperties.class)
public class VideoIntelligenceServiceSpringAutoConfiguration {
  ...
  public VideoIntelligenceServiceSettings videoIntelligenceServiceSettings(
    ...
    if (serviceRetry != null) {
      RetrySettings annotateVideoRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.annotateVideoSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder.annotateVideoSettings().setRetrySettings(annotateVideoRetrySettings);

      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured service-level retry settings from properties.");
      }
    }
    Retry annotateVideoRetry = clientProperties.getAnnotateVideoRetry();
    if (annotateVideoRetry != null) {
      RetrySettings annotateVideoRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.annotateVideoSettings().getRetrySettings(), annotateVideoRetry);
      clientSettingsBuilder.annotateVideoSettings().setRetrySettings(annotateVideoRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("Configured method-level retry settings for annotateVideo from properties.");
      }
    }
