...
public class DataprocMetastoreSpringAutoConfigurationCopy {
  private final DataprocMetastoreSpringProperties clientProperties;
  private final CredentialsProvider credentialsProvider;
  private static final Log LOGGER =
      LogFactory.getLog(DataprocMetastoreSpringAutoConfigurationCopy.class);

  protected DataprocMetastoreSpringAutoConfigurationCopy(
