...
@ConditionalOnProperty(
    value = "com.google.cloud.metastore.v1.spring.auto.dataproc-metastore-federation.enabled",
    matchIfMissing = true)
...
public class DataprocMetastoreFederationSpringAutoConfiguration {
  ...
  /**
   * Provides a DataprocMetastoreFederationClient bean configured to use the default credentials
  ...
  public DataprocMetastoreFederationSettings dataprocMetastoreFederationSettings(
    ...
    if (this.clientProperties.getUseRest()) {
      clientSettingsBuilder.setTransportChannelProvider(
          DataprocMetastoreFederationSettings.defaultHttpJsonTransportProviderBuilder().build());
      if (LOGGER.isTraceEnabled()) {
    ...
    if (serviceRetry != null) {
      ...
      RetrySettings createFederationRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createFederationSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .createFederationSettings()
          .setRetrySettings(createFederationRetrySettings);

      RetrySettings updateFederationRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.updateFederationSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .updateFederationSettings()
          .setRetrySettings(updateFederationRetrySettings);

      RetrySettings deleteFederationRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteFederationSettings().getRetrySettings(), serviceRetry);
      clientSettingsBuilder
          .deleteFederationSettings()
          .setRetrySettings(deleteFederationRetrySettings);
    ...
    Retry createFederationRetry = clientProperties.getCreateFederationRetry();
    if (createFederationRetry != null) {
      RetrySettings createFederationRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createFederationSettings().getRetrySettings(),
              createFederationRetry);
      clientSettingsBuilder
          .createFederationSettings()
          .setRetrySettings(createFederationRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for createFederation from properties.");
      }
    }
    Retry updateFederationRetry = clientProperties.getUpdateFederationRetry();
    if (updateFederationRetry != null) {
      RetrySettings updateFederationRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.updateFederationSettings().getRetrySettings(),
              updateFederationRetry);
      clientSettingsBuilder
          .updateFederationSettings()
          .setRetrySettings(updateFederationRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for updateFederation from properties.");
      }
    }
    Retry deleteFederationRetry = clientProperties.getDeleteFederationRetry();
    if (deleteFederationRetry != null) {
      RetrySettings deleteFederationRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteFederationSettings().getRetrySettings(),
              deleteFederationRetry);
      clientSettingsBuilder
          .deleteFederationSettings()
          .setRetrySettings(deleteFederationRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deleteFederation from properties.");
      }
    }
