...
@ConfigurationProperties("com.google.cloud.gaming.v1.spring.auto.realms-service")
public class RealmsServiceSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for createRealm. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry createRealmRetry;
  /**
   * Allow override of retry settings at method-level for deleteRealm. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteRealmRetry;
  /**
   * Allow override of retry settings at method-level for updateRealm. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry updateRealmRetry;
  /**
  ...
  public Retry getCreateRealmRetry() {
    return this.createRealmRetry;
  }

  public void setCreateRealmRetry(Retry createRealmRetry) {
    this.createRealmRetry = createRealmRetry;
  }

  public Retry getDeleteRealmRetry() {
    return this.deleteRealmRetry;
  }

  public void setDeleteRealmRetry(Retry deleteRealmRetry) {
    this.deleteRealmRetry = deleteRealmRetry;
  }

  public Retry getUpdateRealmRetry() {
    return this.updateRealmRetry;
  }

  public void setUpdateRealmRetry(Retry updateRealmRetry) {
    this.updateRealmRetry = updateRealmRetry;
  }
