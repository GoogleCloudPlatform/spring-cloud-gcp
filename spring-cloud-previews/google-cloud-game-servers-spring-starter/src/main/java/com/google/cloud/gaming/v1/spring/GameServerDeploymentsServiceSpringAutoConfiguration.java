...
@ConditionalOnProperty(
    value = "com.google.cloud.gaming.v1.spring.auto.game-server-deployments-service.enabled",
    matchIfMissing = true)
...
public class GameServerDeploymentsServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a GameServerDeploymentsServiceClient bean configured to use the default credentials
  ...
  public GameServerDeploymentsServiceSettings gameServerDeploymentsServiceSettings(
    ...
    if (this.clientProperties.getUseRest()) {
      clientSettingsBuilder.setTransportChannelProvider(
          GameServerDeploymentsServiceSettings.defaultHttpJsonTransportProviderBuilder().build());
      if (LOGGER.isTraceEnabled()) {
    ...
    if (serviceRetry != null) {
      ...
      RetrySettings createGameServerDeploymentRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createGameServerDeploymentSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .createGameServerDeploymentSettings()
          .setRetrySettings(createGameServerDeploymentRetrySettings);

      RetrySettings deleteGameServerDeploymentRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteGameServerDeploymentSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .deleteGameServerDeploymentSettings()
          .setRetrySettings(deleteGameServerDeploymentRetrySettings);

      RetrySettings updateGameServerDeploymentRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.updateGameServerDeploymentSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .updateGameServerDeploymentSettings()
          .setRetrySettings(updateGameServerDeploymentRetrySettings);
      ...
      RetrySettings updateGameServerDeploymentRolloutRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.updateGameServerDeploymentRolloutSettings().getRetrySettings(),
              serviceRetry);
      clientSettingsBuilder
          .updateGameServerDeploymentRolloutSettings()
          .setRetrySettings(updateGameServerDeploymentRolloutRetrySettings);
    ...
    Retry createGameServerDeploymentRetry = clientProperties.getCreateGameServerDeploymentRetry();
    if (createGameServerDeploymentRetry != null) {
      RetrySettings createGameServerDeploymentRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.createGameServerDeploymentSettings().getRetrySettings(),
              createGameServerDeploymentRetry);
      clientSettingsBuilder
          .createGameServerDeploymentSettings()
          .setRetrySettings(createGameServerDeploymentRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for createGameServerDeployment from properties.");
      }
    }
    Retry deleteGameServerDeploymentRetry = clientProperties.getDeleteGameServerDeploymentRetry();
    if (deleteGameServerDeploymentRetry != null) {
      RetrySettings deleteGameServerDeploymentRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.deleteGameServerDeploymentSettings().getRetrySettings(),
              deleteGameServerDeploymentRetry);
      clientSettingsBuilder
          .deleteGameServerDeploymentSettings()
          .setRetrySettings(deleteGameServerDeploymentRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for deleteGameServerDeployment from properties.");
      }
    }
    Retry updateGameServerDeploymentRetry = clientProperties.getUpdateGameServerDeploymentRetry();
    if (updateGameServerDeploymentRetry != null) {
      RetrySettings updateGameServerDeploymentRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.updateGameServerDeploymentSettings().getRetrySettings(),
              updateGameServerDeploymentRetry);
      clientSettingsBuilder
          .updateGameServerDeploymentSettings()
          .setRetrySettings(updateGameServerDeploymentRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for updateGameServerDeployment from properties.");
      }
    }
    ...
    Retry updateGameServerDeploymentRolloutRetry =
        clientProperties.getUpdateGameServerDeploymentRolloutRetry();
    if (updateGameServerDeploymentRolloutRetry != null) {
      RetrySettings updateGameServerDeploymentRolloutRetrySettings =
          RetryUtil.updateRetrySettings(
              clientSettingsBuilder.updateGameServerDeploymentRolloutSettings().getRetrySettings(),
              updateGameServerDeploymentRolloutRetry);
      clientSettingsBuilder
          .updateGameServerDeploymentRolloutSettings()
          .setRetrySettings(updateGameServerDeploymentRolloutRetrySettings);
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace(
            "Configured method-level retry settings for updateGameServerDeploymentRollout from properties.");
      }
    }
