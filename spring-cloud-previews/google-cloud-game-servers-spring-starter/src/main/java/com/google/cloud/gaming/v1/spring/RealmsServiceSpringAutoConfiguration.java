...
@ConditionalOnProperty(
    value = "com.google.cloud.gaming.v1.realms-service.enabled",
    matchIfMissing = true)
...
public class RealmsServiceSpringAutoConfiguration {
   ...
   */
  @Bean
  @ConditionalOnMissingBean(name = "defaultRealmsServiceTransportChannelProvider")
  public TransportChannelProvider defaultRealmsServiceTransportChannelProvider() {
    if (this.clientProperties.getUseRest()) {
      return RealmsServiceSettings.defaultHttpJsonTransportProviderBuilder().build();
    }
    return RealmsServiceSettings.defaultTransportChannelProvider();
  }

  /**
   * Provides a RealmsServiceSettings bean configured to use the default credentials provider
