...
public class RealmsServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a RealmsServiceSettings bean configured to use a DefaultCredentialsProvider and the
   * client library's default transport channel provider
   * (defaultRealmsServiceTransportChannelProvider()). It also configures the quota project ID and
