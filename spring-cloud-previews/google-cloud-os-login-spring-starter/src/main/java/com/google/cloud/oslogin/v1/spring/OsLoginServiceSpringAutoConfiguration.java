...
@ConditionalOnProperty(
    value = "com.google.cloud.oslogin.v1.spring.auto.os-login-service.enabled",
    matchIfMissing = true)
...
public class OsLoginServiceSpringAutoConfiguration {
  ...
  /**
   * Provides a OsLoginServiceClient bean configured to use the default credentials provider
   * (obtained with osLoginServiceCredentials()) and its default transport channel provider
   * (defaultOsLoginServiceTransportChannelProvider()). It also configures the quota project ID if
