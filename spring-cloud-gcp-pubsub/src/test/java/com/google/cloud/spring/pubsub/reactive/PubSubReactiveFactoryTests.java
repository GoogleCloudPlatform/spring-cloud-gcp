...
public class PubSubReactiveFactoryTests {
	...
	public void testSequentialRequests() throws InterruptedException {
		...
		methodOrder.verify(this.subscriberOperations).pullAsync("sub1", 1);
		methodOrder.verify(this.subscriberOperations).pullAsync("sub1",  3);
	...
	public void testSequentialRequestWithInsufficientDemandGetsSplitIntoTwoRequests() throws InterruptedException {
		...
		InOrder methodOrder = Mockito.inOrder(this.subscriberOperations);
		methodOrder.verify(this.subscriberOperations).pullAsync("sub1", 4);
		methodOrder.verify(this.subscriberOperations).pullAsync("sub1",  3);
		methodOrder.verifyNoMoreInteractions();
	}
	...
	public void testDeadlineExceededCausesRetry() throws InterruptedException {
		...
		InOrder methodOrder = Mockito.inOrder(this.subscriberOperations);
		methodOrder.verify(this.subscriberOperations, times(2)).pullAsync("sub1", 2);
		methodOrder.verifyNoMoreInteractions();
	}
	...
	public void testUnlimitedDemand() throws InterruptedException {
		...
		InOrder methodOrder = Mockito.inOrder(this.subscriberOperations);
		methodOrder.verify(this.subscriberOperations, times(3)).pullAsync("sub1", Integer.MAX_VALUE);
		methodOrder.verifyNoMoreInteractions();
	}
	...
	public void testUnlimitedDemandWithMaxMessages() throws InterruptedException {
		...
		InOrder methodOrder = Mockito.inOrder(this.subscriberOperations);
		methodOrder.verify(this.subscriberOperations, times(5)).pullAsync("sub1", 2);
		methodOrder.verifyNoMoreInteractions();
	}
	...
	public void testUnlimitedDemandWithException() throws InterruptedException {
		...
		InOrder methodOrder = Mockito.inOrder(this.subscriberOperations);
		methodOrder.verify(this.subscriberOperations, times(2)).pullAsync("sub1", Integer.MAX_VALUE);
		methodOrder.verifyNoMoreInteractions();
	}
	...
	private void setUpMessages(String... messages) {
		...
		when(subscriberOperations.pullAsync(eq("sub1"), any(Integer.class))).then(invocationOnMock -> {
