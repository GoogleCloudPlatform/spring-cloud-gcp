...
class DefaultSubscriberFactoryTests {
  ...
  void testNewSubscriber_noMaxAckExtensionPeriodSet_usesClientDefault()
    ...
    java.time.Duration effectiveMaxAckExtensionPeriod =
        (java.time.Duration) FieldUtils.readField(subscriber, "maxAckExtensionPeriod", true);
    java.time.Duration clientDefaultMaxAckExtensionPeriod =
        (java.time.Duration)
            FieldUtils.readField(subscriber, "DEFAULT_MAX_ACK_EXTENSION_PERIOD", true);
