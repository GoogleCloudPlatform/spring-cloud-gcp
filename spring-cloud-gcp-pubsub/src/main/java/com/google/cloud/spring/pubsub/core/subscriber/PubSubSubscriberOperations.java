...
public interface PubSubSubscriberOperations {
   ...
   *
   * @param subscription short subscription name, e.g., "subscriptionName", or the fully-qualified
   *     subscription name in the {@code projects/[project_name]/subscriptions/[subscription_name]}
   *     format
