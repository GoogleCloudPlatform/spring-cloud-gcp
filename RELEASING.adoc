...
. Log in to link:https://oss.sonatype.org/[OSS Sonatype] and verify the contents of the staged package.
The URL should be similar to https://oss.sonatype.org/content/repositories/{STAGING_ID}/com/google/cloud/.
