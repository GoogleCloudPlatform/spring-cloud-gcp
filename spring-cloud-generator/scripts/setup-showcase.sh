...
PROJECT_VERSION=$(./${WORKING_DIR}/../mvnw help:evaluate -Dexpression=project.version -q -DforceStdout)
...
mkdir -p ${WORKING_DIR}/showcase
cp ../bazel-bin/showcase/showcase_java_gapic_spring-spring.srcjar ${WORKING_DIR}/showcase
cd ${WORKING_DIR}/showcase
...
./${WORKING_DIR}/../mvnw com.coveo:fmt-maven-plugin:format -Dfmt.skip=false
