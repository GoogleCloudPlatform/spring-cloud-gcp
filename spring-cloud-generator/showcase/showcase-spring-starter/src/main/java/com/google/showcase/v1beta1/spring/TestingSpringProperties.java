...
@ConfigurationProperties("com.google.showcase.v1beta1.testing")
public class TestingSpringProperties implements CredentialsSupplier {
  ...
  /**
   * Allow override of retry settings at method-level for reportSession. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry reportSessionRetry;
  /**
   * Allow override of retry settings at method-level for listTests. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry listTestsRetry;
  /**
   * Allow override of retry settings at method-level for deleteTest. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry deleteTestRetry;
  /**
   * Allow override of retry settings at method-level for verifyTest. If defined, this takes
   * precedence over service-level retry configurations for that RPC method.
   */
  @NestedConfigurationProperty private Retry verifyTestRetry;
  /**
  ...
  public Retry getReportSessionRetry() {
    return this.reportSessionRetry;
  }

  public void setReportSessionRetry(Retry reportSessionRetry) {
    this.reportSessionRetry = reportSessionRetry;
  }

  public Retry getListTestsRetry() {
    return this.listTestsRetry;
  }

  public void setListTestsRetry(Retry listTestsRetry) {
    this.listTestsRetry = listTestsRetry;
  }

  public Retry getDeleteTestRetry() {
    return this.deleteTestRetry;
  }

  public void setDeleteTestRetry(Retry deleteTestRetry) {
    this.deleteTestRetry = deleteTestRetry;
  }

  public Retry getVerifyTestRetry() {
    return this.verifyTestRetry;
  }

  public void setVerifyTestRetry(Retry verifyTestRetry) {
    this.verifyTestRetry = verifyTestRetry;
  }
