...
This code sample demonstrates consuming data from a Google Cloud Pub/Sub subscription as a reactive stream.
...
port 8080, and send some (`N`) messages to the Google Cloud Pub/Sub topic.
