...
2. Create a Google Cloud Postgres instance and a database within the instance.

- You may create a Google Cloud Postgres instance on the https://console.cloud.google.com/sql/instances[Google Cloud Console Cloud SQL page].
