= Spring Framework on Google Cloud MySQL R2DBC Sample

This code sample demonstrates how to connect to a MySQL Google Cloud SQL instance using the link:../../spring-cloud-gcp-starters/spring-cloud-gcp-starter-sql-mysql-r2dbc[Spring Framework on Google Cloud MySQL R2DBC Starter].
...
- *[instance-connection-name]* with the instance name (in the format [GCP_PROJECT_ID]:[REGION]:[INSTANCE_NAME]) of the MySQL instance you created in step 1.
+
