...
public class SpannerRepositoryExampleDriver {

	private static final Log LOGGER = LogFactory.getLog(SpannerRepositoryExampleDriver.class);
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(SpannerRepositoryExampleDriver.class, args);
	}
