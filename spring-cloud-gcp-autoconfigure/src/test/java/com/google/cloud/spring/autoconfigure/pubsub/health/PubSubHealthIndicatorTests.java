...
class PubSubHealthIndicatorTests {
  ...
  void acknowledgeDisabled() throws Exception {
    ...
    PubSubHealthIndicator healthIndicator =
        new PubSubHealthIndicator(pubSubTemplate, "test", 1000, false);
    healthIndicator.health();
  ...
  void testHealth(Exception e, String customSubscription, Status expectedStatus) throws Exception {
    ...
    PubSubHealthIndicator healthIndicator =
        new PubSubHealthIndicator(pubSubTemplate, customSubscription, 1000, true);
  ...
  void randomSubscription_unexpectedErrorCode() throws Exception {
    Exception e =
        new ExecutionException(new ApiException(null, GrpcStatusCode.of(Code.ABORTED), false));
