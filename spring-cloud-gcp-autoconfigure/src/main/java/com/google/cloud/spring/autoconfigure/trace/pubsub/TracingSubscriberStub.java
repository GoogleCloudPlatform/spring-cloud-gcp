...
public class TracingSubscriberStub extends SubscriberStub {
	...
	@Override
	public UnaryCallable<ListSnapshotsRequest, ListSnapshotsPagedResponse> listSnapshotsPagedCallable() {
