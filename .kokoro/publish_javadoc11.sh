...
# pandoc version: 1.16.0.2, `--defaults` and gfm as output format not available.
sudo pandoc \
  ...
  docs/src/main/md/security-firebase.md   \
...
# group all javadocs to dir and add documentation to top
...
# print 20 lines of toc.yml, debug changes
head -20 toc.yml
