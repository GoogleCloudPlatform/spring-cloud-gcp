...
public final class ObservableReactiveUtil {
   ...
   * stream.
   *
   * @param remoteCall lambda capable of invoking the correct remote call, making use of the {@link
   *     Mono}-converting {@link StreamObserver} implementation.
   ...
   * @param <R> Response type
   */
  static class StreamingObserver<Q, R> implements ClientResponseObserver<Q, R> {
