...
class FirestoreRepositoryRuntimeHintsTest {
  @Test
  void registerSimpleDatastoreRepository() {
    RuntimeHints runtimeHints = new RuntimeHints();
    FirestoreRepositoryRuntimeHints registrar = new FirestoreRepositoryRuntimeHints();
    registrar.registerHints(runtimeHints, null);
    assertThat(runtimeHints).matches(reflection().onType(SimpleFirestoreReactiveRepository.class));
  }
}
