...
class UserCredentialsTokenProviderTest {
    ...
    private static String USER_CREDENTIALS_TOKEN =
            "{\"access_token\":\""+ACCESS_TOKEN+"\",\"token_type\":\"Bearer\",\"expires_in\":3599,\"refresh_token\":\"test_refresh_token\",\"scope\":\"https://www.googleapis.com/auth/cloud-platform\"}";

    private static String USER_CREDENTIALS_TOKEN_BAD_RESPONSE =
            "{\"token\":\""+ACCESS_TOKEN+"\",\"token_type\":\"Bearer\",\"in\":3599,\"refresh_token\":\"test_refresh_token\",\"scope\":\"https://www.googleapis.com/auth/cloud-platform\"}";
    ...
    void testRetrieve() throws Exception {
        ...
        ReactiveTokenProvider tokenProvider = new UserCredentialsTokenProvider(webClient, userCredentials, tokenUrl);
