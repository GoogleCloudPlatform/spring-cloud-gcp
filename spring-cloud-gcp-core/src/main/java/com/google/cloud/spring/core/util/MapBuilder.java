 ...
 *
 * <p>Underlying implementation uses a {@link HashMap}, but disallows
 * {@code null} keys, {@code null} values, and duplicate keys. This is
 * consistent with Java 9 {@code Map.of()} static factory method, which will
 * eventually replace the uses of this utility.
 *
...
public final class MapBuilder<K, V> {
  ...
  /**
   * Returns the underlying modifiable map.
   *
