...
| `spring.cloud.gcp.spanner.project-id`                               | Google Cloud project ID where the Google Cloud Spanner API is hosted, if different from the one in the [Spring Cloud GCP Core Module](#spring-cloud-gcp-core)                                                                        | No       |                                                  |
