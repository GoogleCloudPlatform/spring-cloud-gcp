...
| `loggingEventEnhancer` | none | Classes which implement `com.google.cloud.spring.logging.JsonLoggingEventEnhancer` to extend the JSON logging output (link:https://github.com/GoogleCloudPlatform/spring-cloud-gcp/tree/master/spring-cloud-gcp-logging/src/main/java/com/google/cloud/spring/logging/extensions[examples]).
|=======================================================================
