...
Spring Cloud  link:https://spring.io/blog/2019/07/24/simplifying-the-spring-cloud-release-train[unbundled] Spring Framework on Google Cloud and other cloud providers from their release train.
